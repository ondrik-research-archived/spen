...
;; VC: bsthole(root,parent, M1, M2) * parent |-> ((left,Z), (right,tmp)) * bst(Z, M3) * bst(tmp, M5) & M1 = M0 \ {key} & 
;; M2 = ({parent.data} cup M3 cup M4) \ {key}  & M3 < parent.data < M4  & M5 = M4 \ {key} & parent.data < key 
;; |- 
