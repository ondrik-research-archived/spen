...
;; VC05: bsthole(root0, parent1, M1, M2) * parent1 |-> ((left,X), (right,cur1), (data, d1)) * bst(X,M3) * 
;; cur1 |-> ((left,Y), (right,Z), (data, d2)) * bst(Y, M6) * bst(Z, M7) & M1 = M0 \ {key} & M2 = ({d1} cup M3 cup M4) \ {key} & 
