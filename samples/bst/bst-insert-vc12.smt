...
;; V12: bsthole(root,parent, M1, M2) * parent|->((left,X), (right, Y), (data, d1)) * bst(X,M3) * bst(cur, M4) * 
;; Y |-> ((left,nil), (right, nil), (data, key)) & M3 < d1 < M4 & ite(key in M0, M1 = M0, M1 = M0 cup {key}) & 
