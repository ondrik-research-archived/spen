...
;; bsthole(root,cur1,M1,M2) * cur1 |-> ((left,Y),(right,x)) * bst(Y,M4) * x|-> ((left,nil),(right,nil)) & x.data = key & 
;; M3 = M4 cup {cur1.data} & M4 < cur1.data & cur1 != nil & (key in M0 => M1 = M0) & ((! key in M0) => M1 = M0 cup {key}) & 
