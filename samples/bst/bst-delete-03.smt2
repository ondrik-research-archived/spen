...
;; VC1: bsthole(root, parent1, M1, M2) * parent1 |-> ((left,cur1), (right,Y)) * cur1 |-> ((left,cur2), (right,Z)) * bst(cur2, M5) *
;; bst(Z, M6) * bst(Y,M4) & M1 = M0 \ {key} & M2 = ({parent1.data} cup M3 cup M4) \ {key} & M3 < parent1.data < M4 & 
;; M3 = {cur1.data} cup M5 cup M6 & M5 < cur1.data < M6 & parent1.data > key & cur1.data > key & 
;; parent2 = cur1 & (key in M0 <=> key in M3) & M22 = M3 \ {key} |-
