...
(assert 
	...
	(ssep 
		...
		(index alpha0 (skl1 x2_0_1 x2_1 )) 
		(index alpha1 (skl2 x2_1 x2_2 )) 
		(pto x2_2 (sref (ref n3 nil) (ref n2 x3) (ref n1 x2_2_1) ) ) 
		(index alpha2 (skl1 x2_2_1 x2_2_2 )) 
		(pto x2_2_2 (sref (ref n3 nil) (ref n2 nil) (ref n1 x3) ) ) 
		(pto x3 (sref (ref n3 x4) (ref n2 x3_1) (ref n1 x3_0_1) ) ) 
		(index alpha3 (skl1 x3_0_1 x3_1 )) 
		(index alpha4 (skl2 x3_1 x4 )) 
		(index alpha5 (skl3 x4 nil )) 
	)
