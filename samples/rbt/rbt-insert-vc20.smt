...
(assert 
	...
	(ssep 
		...
		(pto cusnode (sref (ref left Y) (ref right unc) (ref data d2) (ref color 0)))
		(index alpha3 (rbt unc M4 N4 C4))
		(pto pa (sref (ref left gra) (ref right cusnode) (ref data d3) (ref color 1)))
		(index alpha4 (rbt Y M5 N5 C5))
		(pto gra (sref (ref left U1) (ref right V1) (ref data d4) (ref color 0)))
	...
	(=> (= c1 0) (and (= c2 1) (= C3 1)) ) (= C2  c1) (= M2  (bagunion (bag d3) M6 M5 (bag d2) M4 (bag d1) M3) )
