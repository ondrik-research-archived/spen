...
(assert 
	...
	(=> (= C8 0) (and (= C12 1) (= C13 1)) ) (= M8 (bagunion M12 (bag d7) M13) )
	...
	(distinct cusparent1 nil) (= is_even 1) (= c5 0) (= C5 0) (= ggrandpa2 grandpa1) (= grandpa2 parent1)
	(= uncle2 V) (= parent2 cur1) (= cur2 U1)
	)
)
...
(assert (not 
	...
	(ssep 
		...
		(pto cusnode2 (sref (ref left ggra) (ref right Y) (ref data d2) (ref color c2))) 
		(index alpha12 (rbt Y M4 N4 C4))
		(pto ggra (sref (ref left ggrandpa2) (ref right U) (ref data d3) (ref color c3)))
		(index alpha13 (rbt U M5 N5 C5))
		(pto ggrandpa2 (sref (ref left grandpa2) (ref right U) (ref data d4) (ref color c4)))
		(index alpha14 (rbt U M6 N6 C6)) 
	...
	(=> (= c5 0) (and (= C8 1) (= C7 1)) (< (bagunion M12 (bag d7) M13 (bag d5) M7) (bag d4)) (< (bag d4) M6)
	(= N6 (ite (= c5 0) N7 (+ N7 1)) )  (<= 0  c4) (<= c4 1) (=> (= c4 0) (and (= c5 1) (= C6 1)) ) 
	...
	(= N2  (ite (= c1 0) N3 (+ N3 1)) ) (= C2 c1) (= (bagunion M0 (bag key)) M1)
	(= M0 (bagminus M0 (bag key))) (distinct parent0 nil) (distinct parent0 root)	
	(distinct cusparent2 nil) (= is_even 1)
	)
))
