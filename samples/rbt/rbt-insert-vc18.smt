...
(assert 
	...
	(ssep 
		...
		(pto cusnode (sref (ref left V1) (ref right unc) (ref data d2) (ref color 0)))
		(index alpha3 (rbt unc M4 N4 C4))
		(pto pa (sref (ref left Y) (ref right U1) (ref data d3) (ref color c3)))
		(index alpha4 (rbt Y M5 N5 C5))
		(pto gra (sref (ref left pa) (ref right cusnode) (ref data d4) (ref color 1)))
		(index alpha5 (rbt V1 M8 N8 1))
		(pto U1 (sref (ref left U2) (ref right V2) (ref data d5) (ref color 1)))
		(index alpha6 (rbt V2 M9 N9 C9)) 
		(index alpha7 (rbrbthole U2 x M10 N10 0 M7 N7 0))
	...
	(< (bagunion (d3) M6 M5 (bag d2) M4) (bag d1)) (< (bag d1) M3) 
	(= N3 (ite (= c2 0) N4 (+ N4 1)) )(<= 0 c1) (<= c1 1) (=> (= c1 0) (and (= c2 1) (= C3 1)) ) (= C2 c1)
