...
;; VC18: 
;; rbthole(root,cusparent,M1,N1,C1,M2,N2,C2) * cusparent |-> ((left, gra),(right,X),(data,d1),(color,c1)) * rbt(X,M3,N3,C3) * cusnode |-> ((left,V1),
;; (right,unc),(data,d2),(color,0)) * rbt(unc,M4,N4,C4) * pa |-> ((left,Y),(right,U1),(data,d3),(color,c3)) * rbt(Y,M5,N5,C5) * gra |-> ((left,pa),
;; (right,cusnode),(data,d4),(color,1)) * rbt(V1,M8,N8,1) * U1|->((left,U2),(right,V2),(data,d5),(color,1)) * rbt(V2,M9,N9,C9) * rbrbthole
;; (U2,x,M10,N10,0,M7,N7,0) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) 
;; & M10 < d5 < M9 & N10 = N9 & M10 cup {d5} cup M9 < d4 < M8 & N9+1 = N8 & M6 = M10 cup {d5} cup M9 cup {d4} cup M8 & N6 = N8 & M7 = {key} & N7 = 1 
;; & M5 < d3 < M6 & N5 = N6 & 0 <= c3 <= 1 & (c3 =0 => C5 =1) & {d3} cup M5 cup M6 < d2 < M4 & n3 = ite(c3 =0, N5, N5+1) & n3=N4 & 0 <=c2 <= 1 & 
;; (c2=0 => c3 = 1 & C4=1) & {d3} cup M6 cup M5 cup {d2} cup M4 < d1 < M3 & n2 = ite(c2 = 0, N4, N4+1) & n2=N3 & 0 <=c1 <= 1 & (c1=0 => c2 = 1 & 
;; C3=1) & C2 = c1 & M2 = {d3} cup M6 cup M5 cup {d2} cup M4 cup {d1} cup M3 & N2 = ite(c1=0, N3, N3+1) & ! key in M0 & ! cusparent = nil & c3 =0 & 
;; C4=1 & ret = root
;; |-
...
(assert 
	...
	(ssep 
		...
		(pto cusparent (sref (ref left gra) (ref right X) (ref data d1) (ref color c1)))
		(index alpha2 (rbt X M3 N3 C3))
		(pto cusnode (sref (ref left V1) (ref right unc) (ref data d2) (ref color c2)))
		(index alpha3 (rbt unc M4 N4 C4))
		(pto pa (sref (ref left Y) (ref right U1) (ref data d3) (ref color c3)))
		(index alpha4 (rbt Y M5 N5 C5))
		(pto gra (sref (ref left pa) (ref right cusnode) (ref data d4) (ref color c4)))
		(index alpha5 (rbt V1 M8 N8 C8))
		(pto U1 (sref (ref left U2) (ref right V2) (ref data d5) (ref color c5)))
		(index alpha6 (rbt V2 M9 N9 C9)) 
		(index alpha7 (rbrbthole U2 x M10 N10 C10 M7 N7 C7))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c6))) 
	))
	(< M10 (bag d5)) (< (bag d5) M9)(= N10 N9) (< (bagunion M10 (bag d5) M9) (bag d4)) (< (bag d4) M8)
	(= (+ N9 1) N8) (= M6 (bagunion M10 (bag d5) M9 (bag d4) M8) ) (= N6 N8) (= M7 (bag key)) 
	(= N7 1) (< M5 (bag d3)) (<  (bag d3) M6) (= N5 N6) (<= 0 c3) (<= c3 1) (=> (= c3 0) (= C5 1))
	(< (bagunion (bag d3) M5 M6) (bag d2)) (< (bag d2) M4)
	(= N4 (ite (= c3 0) N5 (+ N5 1)) ) 
	(<= 0 c2) (<= c2 1) (=> (= c2 0) (= c3 1) ) (=> (= c2 0) (= C4 1) )
	(< (bagunion (bag d3) M6 M5 (bag d2) M4) (bag d1)) (< (bag d1) M3) 
	(= N3 (ite (= c2 0) N4 (+ N4 1)) )(<= 0 c1) (<= c1 1) (=> (= c1 0) (= c2 1) ) (=> (= c1 0) (= C3 1) ) (= C2 c1)
	(= M2 (bagunion (bag d3) M6 M5 (bag d2) M4  (bag d1) M3) )(= N2 (ite (= c1 0) N3 (+ N3 1)) ) 
	(= M0 (bagminus M0 (bag key)) )(distinct cusparent nil) (= c3 0) (= C4 1) (= ret root) 
	(= c2 0) (= c4 1) (= c5 1) (= C10 0) (= C7 0) (= C8 1) (= c6 0)	
	)
)
