...
;; rbt(U1,M5,N5,C5) * brrbthole(cu1,cu2,M6,N6,C6,M7,N7,C7) * cu2 |-> ((left,ggrandpa1),(right,U),(data,d4),(color,c4)) * rbt
;; (U,M8,N8,C8) * ggrandpa1 |-> ((left,grandpa1),(right,V),(data,d5),(color,c5)) * rbt(V,M9,N9,C9) * grandpa1 |-> ((left,parent0),
;; (right,uncle1),(data,d6),(color,c6)) * rbt(uncle1,M10,N10,C10) * parent0 |-> ((left,x),(right,Z),(data,d7),(color,c7)) * x |-> 
;; ((left,nil),(right,nil),(data,key),(color,0)) * rbt(Z,M11,N11,C11)
;; & key < d7 < M11 & N11 = 1 & 0<=c7<=1 & (c7 = 0 => C11 = 1) & {key} cup {d7} cup M11 < d6 < M10 & n7 = ite(c7=0,N11,N11+1) & 
;; n7=N10 & 0<=c6 <=1 & (c6 =0 => c7 = 1 & C10 =1) & {key} cup {d7} cup M11 cup {d6} cup M10 < d5 < M9 & n6 = ite(c6=0,N10,N10+1) & 
;; n6=N9 & 0<=c5 <=1 & (c5 =0 => c6 = 1 & C9 =1) & {key} cup {d7} cup M11 cup {d6} cup M10 cup {d5} cup M9 < d4 < M8 & n5 = ite
;; (c5=0,N9,N9+1) & n5=N8 & 0<=c4 <=1 & (c4 =0 => c5 = 1 & C8 =1) & M7 = {key} cup {d7} cup M11 cup {d6} cup M10 cup {d5} cup M9 
;; cup {d4} cup M8 & N7 = ite(c4=0,N8,N8+1) & C7 = c4 & M6 < d3 < M5 & N6=N5 & 0 <= c3 <= 1 & (c3=0=> C6=1 & C5=1) & M6 cup {d3} 
;; cup M5 < d2 < M4 & n3=N4 & n3 = ite(c3=0,N5,N5+1) & 0 <= c2 <= 1 & (c2=0=> c3=1 & C4=1) & M6 cup {d3} cup M5 cup {d2} cup M4 < 
;; d1 < M3 & n2=N3 & n3 = ite(c2=0,N4,N4+1) & 0 <= c1 <= 1 & (c1=0=> c2=1 & C3=1) & M2 = M6 cup {d3} cup M5 cup {d2} cup M4 cup 
;; {d1} cup M3 & N2 = ite(c1=0,N3,N3+1) & C2=c1 & M1 = M0 cup {key} & ! key in M0 & ! parent0 = nil & ! parent0 = root & ! 
;; cusparent1 = nil & is_even = 1 & c5 = 0 & C8 = 0 & c7 = 0 & C10 = 0 & parent1= parent0 & cur1 = x & ggrandpa2 = grandpa1 & 
;; grandpa2 = parent1 & uncle2 = Z & parent2 = cur1 & cur2 = nil
;; |-
...
;; rbt(U1,M5,N5,C5) * brrbthole(cu1, ggrandpa2,M6,N6,C6,M13,N13,C13) * ggrandpa2 |-> ((left,parent0),(right,uncle1),(data,d6),
;; (color,c6)) * rbt(uncle1,M10,N10,C10) * parent0 |-> ((left,x),(right,Z),(data,d7),(color,c7)) * x |-> ((left,nil),(right,nil),
;; (data,key),(color,0)) * rbt(Z,M11,N11,C11)
;; & key < d7 < M11 & N11 = 1 & 0<=c7<=1 & (c7 = 0 => C11 = 1) & {key} cup {d7} cup M11 < d6 < M10 & n7 = ite(c7=0,N11,N11+1) & 
;; n7=N10 & 0<=c6 <=1 & (c6 =0 => c7 = 1 & C10 =1) & M13 = {key} cup {d7} cup M11 cup {d6} cup M10 & N13 = ite(c6=0,N10,N10+1) & 
;; C13=c6 & M6 < d3 < M5 & N6=N5 & 0 <= c3 <= 1 & (c3=0=> C6=1 & C5=1) & M6 cup {d3} cup M5 < d2 < M4 & n3=N4 & n3 = ite
;; (c3=0,N5,N5+1) & 0 <= c2 <= 1 & (c2=0=> c3=1 & C4=1) & M6 cup {d3} cup M5 cup {d2} cup M4 < d1 < M3 & n2=N3 & n3 = ite
;; (c2=0,N4,N4+1) & 0 <= c1 <= 1 & (c1=0=> c2=1 & C3=1) & M2 = M6 cup {d3} cup M5 cup {d2} cup M4 cup {d1} cup M3 & N2 = ite
;; (c1=0,N3,N3+1) & C2=c1 & M1 = M0 cup {key} & ! key in M0 & ! parent0 = nil & ! parent0 = root & ! cusparent1 = nil & is_even = 1 
;; & c7 = 0 & C10 = 0 & grandpa2= parent0 & parent2 = x & cur2=nil & uncle2 = Z
...
(assert 
	...
	(ssep 
		...
		(index alpha3 (rbt Y M4 N4 C4)) (pto pa (sref (ref left cu1) (ref right U1) (ref data d3) (ref color c3)))
		...
		(pto grandpa1 (sref (ref left parent0) (ref right uncle1) (ref data d6) (ref color c6)))
		(index alpha8 (rbt uncle1 M10 N10 C10))
		(pto parent0 (sref (ref left x) (ref right Z) (ref data d7) (ref color c7)))
		(pto x (sref (left nil) (ref right nil) (ref data key) (ref color 0)))
		(index alpha9 (rbt Z M11 N11 C11))
	))
	(< key d7) (< (bag d7) M11) (= N11 1) (<= 0 c7) (<= c7 1) (=> (= c7 0) (= C11 1))
	(< (bagunion (bag key) (bag d7) M11) (bag d6)) (< (bag d6) M10)
	(N10 (ite (= c7 0) N11 (+ N11 1)) ) (<= 0 c6) (<=c6 1) (=> (= c6 0) (and (= c7 1) (= C10 1)) ) 
	(< (bagunion (bag key) (bag d7) M11 (bag d6) M10) (bag d5)) (< (bag d5) M9) 
	(= N9 (ite (= c6 0) N10 (+ N10 1)) ) (<= 0 c5) (<=c5 1) (=> (= c5 0) (and (= c6 1) (= C9 1)) )
	(< (bagunion  (bag key) (bag d7) M11 (bag d6) M10  (bag d5) M9) (bag d4)) (< (bag d4) M8) 
	(= N8 (ite (= c5 0) N9 (+ N9 1)) ) (<= 0 c4) (<=c4 1) (=> (= c4 0) (and (= c5 1) (= C8 1)) ) 
	...
	(=> (= c3 0) (and (= C6 1) (= C5 1)) ) (< (bagunion M6 (bag d3) M5) (bag d2)) (< (bag d2) M4)
	...
	(= M2 (bagunion M6 (bag d3) M5 (bag d2) M4 (bag d1) M3) ) (= N2 (ite (= c1 0) N3 (+ N3 1)) ) 
	(= C2 c1) (= M1 (bagunion M0  (bag key)) ) (= M0 (bagminus M0 (bag key)) )
	(distinct parent0 nil) (distinct parent0 root) (distinct cusparent1 nil) (= is_even 1) 
	(= c5 0) (= C8 0) (= c7 0) (= C10 0) (= parent1 parent0) (= cur1 x) (= ggrandpa2 grandpa1)
	(= grandpa2 parent1) (= uncle2 Z) (= parent2 cur1) (= cur2 nil) 
	)
)
...
(assert (not 
	...
	(ssep 
		...
		(index alpha13 (rbt U1 M5 N5 C5))
		(index alpha14 (brrbthole cu1 ggrandpa2 M6 N6 C6 M13 N13 C13))
		(pto ggrandpa2 (sref (ref left parent0) (ref right uncle1) (ref data d6) (ref color c6)))
		(index alpha15 (rbt uncle1 M10 N10 C10))
		(pto parent0 (sref (ref left x) (ref right Z) (ref data d7) (ref color c7)))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color 0)))
		(index alpha16 (rbt Z M11 N11 C11))
	))
	(< key d7) (< (bag d7) M11)
	(= N11 1) (<= 0 c7) (<=c7 1) (=> (= c7 0) (= C11 1))  (< (bagunion (bag key) (bag d7) M11) (bag d6))
	((bag d6) M10) (= N10 (ite (= c7 0) N11 (+ N11 1)) ) (<= 0 c6) (<= c6 1) (=> (= c6 0) (and (= c7 1) (= C10 1)) )
	(= M13 (bagunion (bag key) (bag d7) M11 (bag d6) M10) ) (= N13 (ite (= c6 0) N10 (+ N10 1))) 
	(= C13 c6) (< M6 (bag d3)) (< (bag d3) M5) (= N6 N5) (<= 0 c3) (<= c3 1)
	(=> (= c3 0) (and (= C6 1) (= C5 1)) ) (< (bagunion M6 (bag d3) M5)  (bag d2)) (< (bag d2) M4)
	(= N4 (ite (= c3 0) N5 (+ N5 1)) ) (<= 0 c2) (<= c2 1)
	(=> (= c2 0) (and (= c3 1) (= C4 1))) (< (bagunion M6 (bag d3) M5 (bag d2) M4) (bag d1)) (< (bag d1) M3) 
	(= N3 (ite (= c2 0) N4 (+ N4 1)) ) (<= 0 c1) (<= c1 1) (=> (= c1 0) (and (= c2 1) (= C3 1)) )
	...
	(= is_even 1) (= c7 0) (= C10 0) (= grandpa2 parent0) (= parent2 x) (= cur2 nil) (= uncle2 Z)
	)
))
