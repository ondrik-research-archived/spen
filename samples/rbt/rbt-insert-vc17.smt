...
(assert 
	...
	(ssep 
		...
		(index alpha3 (rbrbthole gra x M4 N4 0 M5 N5 0)) 
	...
	(=> (= c1 0) (and (= c2 1) (= C2 1)) ) (= (bagunion M0 (bag key)) (bagunion (bag d2) M4  M3 (bag d1) M2) )
	(= M0 (bagminus M0 (bag key)) )(= cusparent nil) (= c1 1) (= c2 1) (= C2 1) (= ret root)
	(= M7 (bagunion (bag d2) M4 M3 (bag d1) M2) ) (= N7 (+ N2 1)) (= C7 1)
	)
)
