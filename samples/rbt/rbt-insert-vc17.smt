...
;; VC17:
;; cusnode |-> ((left,pa),(right,unc),(data,d1),(color,c1)) * rbt(unc,M2,N2,C2) * pa |-> ((left,gra),(right,X),(data,d2),(color,c2)) * 
;; rbt(X,M3,N3,C3) * rbrbthole(gra,x,M4,N4,0,M5,N5,0) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) & M6 = {key} & N6 = 1 & M4 < d2 < M3 & 
;; N4 = N3 & 0 <= c2 <= 1 & (c2 =0 => C3 =1) & {d2} cup M4 cup M3 < d1 < M2 & n2 = ite(c2 =0, N3, N3+1) & n2=N2 & 0 <=c1 <= 1 & (c1=0 => c2 = 1 &
;;  C2=1) & M0 cup {key} = {d2} cup M4 cup M3 cup {d1} cup M2 & ! key in M0 & cusparent = nil & c1=1 & c2=1 & C2=1 & ret = root & 
;; M7 = {d2} cup M4 cup M3 cup {d1} cup M2 & N7 = N2+1 & C7 = 1
;; |-
...
(assert 
	...
	(ssep 
		...
		(index alpha3 (rbrbthole gra x M4 N4 C4 M5 N5 C5)) 
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c3)))
	))
	(= M6 (bag key)) (= N6 1) (< M4 (bag d2)) (< (bag d2) M3) (= N4 N3)
	(<= 0 c2) (<= c2 1) (=> (= c2 0) (= C3 1))
	(< (bagunion (bag d2) M4 M3) (bag d1)) (< (bag d1) M2)
	(= N2 (ite (= c2 0) N3 (+ N3 1)) ) (<= 0  c1) (<= c1 1)
	(=> (= c1 0) (= c2 1) ) (=> (= c1 0) (= C2 1) ) (= (bagunion M0 (bag key)) (bagunion (bag d2) M4  M3 (bag d1) M2) )
	(= M0 (bagminus M0 (bag key)) )(= cusparent nil) (= c1 1) (= c2 1) (= C2 1) (= ret root) (= cusnode root)
	(= M7 (bagunion (bag d2) M4 M3 (bag d1) M2) ) (= N7 (+ N2 1)) (= C7 1) (= C4 0) (= C5 0) (= c3 0)
	)
)
