...
(assert 
	...
	(= iseven 1) (>= (+ c5 C7) 1) (= parent1 parent0) (= cur1 x) (= cusnode2 grandpa1) (= cusparent2 ggrandpa1)
	(= ggrandpa2 grandpa1) (= grandpa2 parent1) (= parent2 cur1) (= cur2 nil) (= uncle2 Z)  (= c6 0)
	)
)
...
(assert (not 
	...
	(ssep 
		...
		(pto cusparent2 (sref (ref left cusnode2) (ref right V) (ref data d3) (ref color c3)) ) 
		(index alpha8 (rbt V M5 N5 C5)) 
		(pto cusnode2  (sref (ref left parent0) (ref right uncle1) (ref data d4) (ref color c4)))
		(index alpha9 (rbt uncle1 M6 N6 C6)) 
		(pto parent0 (sref (ref left x) (ref right Z) (ref data d5) (ref color c5)) )
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c6)) )
	...
	(distinct cusparent2 nil) (= iseven 1) (= cusnode2 ggrandpa2)
	(= grandpa2 parent0) (= parent2 x) (= cur2 nil) (= uncle2 Z) (= c6 0)
	)
))
