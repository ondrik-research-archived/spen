...
(assert 
	...
	(= C1 1) (iff (subset (bag key) M0) (subset (bag key) M3)) 
	(> d1 key) (distinct parent nil) (= is_even 1) (= cur nil) 
	)
)
...
(assert (not 
	...
	(= M1 (bagunion M0 (bag key))) (= C1 1) (= M0 (bagminus M0 (bag key))) 
	(distinct parent nil) (= is_even 1)
	)
))
