...
(assert 
	...
	(tobool 
	(ssep 
		(pto cusnode (sref (ref left X) (ref right unc) (ref data d1) (ref color c1)))
		(index alpha1 (rbt unc M2 N2 C2))
		(pto pa (sref (ref left gra) (ref right cusnode) (ref data d2) (ref color c2)))
		(index alpha2 (rbt X M3 N3 C3))
		(pto gra (sref (ref left U1) (ref right V1) (ref data d3) (ref color c3)))
		(index alpha3 (rbt V1 M7 N7 C7))
		(pto U1 (sref (ref left U2) (ref right V2) (ref data d4) (ref color c4)))
		(index alpha4 (rbt V2 M8 N8 C8))
		(index alpha5 (rbrbthole U2 x M9 N9 C9 M5 N5 C5))
	...
	(= N6 (+ N3 1)) (= C6 1) (= c1 0) (= c2 1) (= c3 0) (= c4 1) (= C7 1) (= C9 0) (= C5 0) (= c5 0)
	)
)
