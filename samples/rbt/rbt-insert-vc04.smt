...
;; cusnode1 = grandpa1 & is_even = 1 & (c3 = 1 | C4 = 1) & parent2 = cur1 & cur2 = U1
;; |-
...
(assert 
	...
	(=> (= c5 0) (and (= C9 1) (= C10 1))) (= M6 (bagunion (bag d5) M9 M10)) 
	(= N6 (ite (= c5 0) N10 (+ N10 1))) (= C6 c5)
	(< key d4) (< d4 M8) (= N8 1) (<= 0 c4) (<= c4 1)
	...
	(=> (= c1 0) (and (= c2 1) (= C3 1)) (= (bagunion M0 (bag key)) (bagunion (bag d3) M6 M5 (bag d2) M4 (bag d1) M3))
	(= M0 (bagminus M0 (bag key))) (distinct parent0 nil) (distinct parent0 root) (= cusparent1 root)
	(= cusparent1 ggrandpa1) (= cusnode1 grandpa1) (= is_even 1) & (>= (+ c3 C4) 1) (= parent2 cur1) (= cur2 U1)
	)
)
