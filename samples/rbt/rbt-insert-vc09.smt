...
;; VC09: 
;; cusparent1 |-> ((left,cusnode1),(right,X),(data,d1),(color,c1)) * rbt(X,M3,N3,C3) * cusnode1 |-> ((left, parent1),(right,uncle1),
;; (data,d2),(color,c2)) * rbt(uncle1,M4,N4,C4) * parent1 |-> ((left,cur1),(right,Z),(data,d3),(color,c3)) * rbt(Z,M5,N5,C5) * 
;; cur1 |-> ((left,V),(right,U),(data,d5),(color,c5)) * rbthole(V,parent0,M9,N9,C9,M7,N7,C7) * rbt(U,M10,N10,C10) * 
;; parent0 |-> ((left,x),(right,Z),(data,d4),(color,c4)) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) * rbt(Z,M8,N8,C8)
;; &
;; M9 < d5 < M10 & N9 = N10 & 0 <=c5 <=1 & (c5=0 => C9=1 & C10 = 1) & M6=M9 cup {d5} cup M10 & N6= ite(c5=0,N9,N9+1) & C6=c5 & 
;; key < d4 < M8 & N8=1 & 0<=c4 <= 1 & c4=0 => C8 = 1 & M7 = {d4} cup {key} cup M8 & N7=ite(c4=0,N8,N8+1) & C7=c4 & M7 < d3 < M5 & 
;; N6 = N5 & 0<=c3 <= 1 & (c3 =0 => C6 =1 & C5 = 1) & {d3} cup M6 cup M5 < d2 < M4 & n3=ite(c3=0, N5,N5+1) & n3 = N4 & 0<=c2 <= 1 &
;; (c2 =0 => c3 =1 & C4 = 1) & {d3} cup M6 cup M5 cup {d2} cup M4 < d1 < M3 & n2=ite(c2=0,N4,N4+1) & n2=N3 & 0 <=c1 <= 1 & 
;; (c1 = 0 => c2 =1 & C3 = 1) & M0 cup {key} = {d3} cup M6 cup M5 cup {d2} cup M4 cup {d1} cup M3 & ! key in M0 & ! parent0 = nil & 
;; ! parent0 = root & cusparent1 = root & cusparent1 = ggrandpa1 & cusnode1 = grandpa1 & is_even = 1 & c3 = 0 & C4 = 0 & 
;; ggrandpa2 = grandpa1 & grandpa2 = parent1 & uncle2 = Z & parent2 = cur1 & cur2 = V
;; |-
;; cusparent2 |-> ((left,cusnode2),(right,X),(data,d1),(color,c1)) * rbt(X,M3,N3,C3) * cusnode2 |-> ((left, grandpa2),(right,uncle1),
;; (data,d2),(color,c2)) * rbt(uncle1,M4,N4,C4) * grandpa2 |-> ((left,parent2),(right,uncle2),(data,d3),(color,c3)) * rbt
;; (uncle2,M5,N5,C5) * parent2 |-> ((left,cur2),(right,U),(data,d5),(color,c5)) * rbthole(cur2,parent0,M9,N9,C9,M7,N7,C7) * rbt
;; (U,M10,N10,C10) * parent0 |-> ((left,x),(right,Z),(data,d4),(color,c4)) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) * rbt
;; (Z,M8,N8,C8)
;; & M9 < d5 < M10 & N9 = N10 & 0 <=c5 <=1 & (c5=0 => C9=1 & C10 = 1) & key < d4 < M8 & N8=1 & 0<=c4 <= 1 & c4=0 => C8 = 1 & M7 = {d4} 
;; cup {key} cup M8 & N7=ite(c4=0,N8,N8+1) & C7=c4 & M9 cup {d5} cup M10 < d3 < M5 & n5=ite(c5=0, N10, N10+1) & n5 = N5 & 0<=c3 <= 1 & 
;; (c3 =0 => c5 =1 & C5 = 1) & M9 cup {d5} cup M10 cup {d3} cup M5 < d2 < M4 & n3=ite(c3=0, N5,N5+1) & n3 = N4 & 0<=c2 <= 1 & (c2 =0 
;; => c3 =1 & C4 = 1) & M9 cup {d5} cup M10 cup {d3} cup M5 cup {d2} cup M4 < d1 < M3 & n2=ite(c2=0,N4,N4+1) & n2=N3 & 0 <=c1 <= 1 & 
;; (c1 = 0 => c2 =1 & C3 = 1) & M0 cup {key} = M9 cup {d5} cup M10 cup {d3} cup M5 cup {d2} cup M4 cup {d1} cup M3 & ! key in M0 & ! 
;; parent0 = nil & ! parent0 = root & cusparent2 = root & cusnode2 = ggrandpa2 & is_even = 1
...
(assert 
	...
	(ssep 
		...
		(pto parent1 (sref (ref left cur1) (ref right Z) (ref data d3) (ref color c3)) )
		(index alpha3 (rbt Z M5 N5 C5) ) 
		(pto cur1 (sref (ref left V) (ref right U) (ref data d5) (ref color c5)) )
		(index alpha4 (rbthole V parent0 M9 N9 C9 M7 N7 C7) )
	...
	(< M9 (bag d5)) (< (bag d5) M10) (= N9 N10) (<= 0 c5) (<= c5 1) (=> (= c5 0) (= C9 1) ) (=> (= c5 0) (= C10 1) ) 
	(= M6 (bagunion M9 (bag d5) M10) ) (= N6 (ite (= c5 0) N9 (+ N9 1)) ) 
	(= C6 c5) (< key d4) (< (bag d4) M8) (= N8 1) (<= 0 c4) (<= c4 1)
	(=> (= c4 0) (= C8 1)) (= M7 (bagunion (bag d4) (bag key) M8) ) 
	(= N7 (ite (= c4 0) N8 (+ N8 1)) ) (= C7 c4) (< M7 (bag d3)) (< (bag d3) M5)
	(= N6 N5) (<= 0 c3) (<= c3 1) (=> (= c3 0) (= C6 1)) (=> (= c3 0) (= C5 1) )
	(< (bagunion (bag d3) M6 M5) (bag d2)) (< (bag d2) M4) (= N4 (ite (= c3 0) N5 (+ N5 1)) ) 
	(<= 0 c2) (<= c2 1) (=> (= c2 0) (= c3 1) ) (=> (= c2 0) (= C4 1) ) 
	(< (bagunion (bag d3) M6 M5 (bag d2) M4) (bag d1)) (< (bag d1) M3) 
	(= N3 (ite (= c2 0) N4 (+ N4 1)) ) (<= 0 c1) (<= c1 1) (=> (= c1  0) (= c2 1) ) (=> (= c1  0) (= C3 1) ) 
	(= (bagunion M0 (bag key)) (bagunion (bag d3) M6  M5 (bag d2) M4 (bag d1) M3) ) 
	(= M0 (bagminus M0 (bag key)) ) (distinct parent0 nil) (distinct parent0 root) (= cusparent1 root) (= cusparent1 ggrandpa1)
	(= cusnode1 grandpa1) (= iseven 1) (= c3 0)  (= C4 0) (= cusparent2 cusparent1) (= cusnode2 cusnode1)
	(= ggrandpa2 grandpa1) (= grandpa2 parent1) (= uncle2 Z) (= parent2 cur1) (= cur2 V) (= c6 0)
	)
)
...
(assert (not 
	...
	(ssep 
		...
		(index alpha7 (rbt X M3 N3 C3)) 
		(pto cusnode2 (sref (ref left grandpa2) (ref right,uncle1) (ref data d2) (ref color c2)) )
		(index alpha8 (rbt uncle1 M4 N4 C4))
		(pto grandpa2 (sref (ref left parent2) (ref right uncle2) (ref data d3) (ref color c3)) )
		(index alpha9 (rbt uncle2 M5 N5 C5) ) 
		(pto parent2 (sref (ref left cur2) (ref right U) (ref data d5) (ref color c5)) )
		(index alpha10 (rbthole cur2 parent0 M9 N9 C9 M7 N7 C7) )
		(index alpha11 (rbt U M10 N10 C10) )
		(pto parent0 (sref (ref left x) (ref right Z) (ref data d4) (ref color c4)) )
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c6)) )
		(index alpha12 (rbt Z M8 N8 C8) )
	))
	(< M9 (bag d5)) (< (bag d5) M10) (= N9 N10) (<= 0 c5) (<= c5 1) (=> (= c5 0) (= C9 1) ) ( => (= c5 0) (= C10 1) ) 
	(< key d4) (< (bag d4) M8) (= N8 1) (<= 0 c4) (<= c4 1) (=> (= c4 0) (= C8 1)) 
	(= M7 (bagunion (bag d4) (bag key) M8) ) 
	(= N7 (ite (= c4 0) N8 (+ N8 1)) ) 
	(= C7 c4)  (< (bagunion M9 (bag d5) M10) (bag d3)) (< (bag d3) M5)
	(= N5 (ite (= c5 0) N10 (+ N10 1)) ) (<= 0 c3) (<= c3 1) (=> (= c3 0) (= c5 1) ) (=> (= c3 0) (= C5 1) ) 
	(< (bagunion M9 (bag d5) M10 (bag d3) M5) (bag d2)) (< (bag d2) M4)
	(= N4 (ite (= c3 0) N5 (+ N5 1)) ) (<= 0 c2) (<= c2 1)
	(=> (= c2 0) (= c3 1) ) (=> (= c2 0) (= C4 1) ) 
	(< (bagunion M9 (bag d5) M10 (bag d3) M5 (bag d2) M4) (bag d1)) (< (bag d1) M3) 
