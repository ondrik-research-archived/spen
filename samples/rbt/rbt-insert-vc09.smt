...
(assert 
	...
	(< M9 (bag d5)) (< (bag d5) M10) (=N9 N10) (<= 0 c5) (<= c5 1) (=> (= c5 0) (and (= C9 1) (= C10 1)) ) 
	...
	(= N6 N5) (<= 0 c3) (<= c3 1) (=> (= c3 0) (and (= C6 1) (= C5 1)) )
	...
	(= cusnode1 grandpa1) (= is_even 1) (= c3 0)  (= C4 0)
	(= ggrandpa2 grandpa1) (= grandpa2 parent1) (= uncle2 Z) (= parent2 cur1) (= cur2 V)
	)
)
...
(assert (not 
	...
	(ssep 
		...
		(index alpha1 (rbt X M3 N3 C3)) 
		(pto cusnode2 (sref (ref lef grandpa2) (ref right,uncle1) (ref data d2) (ref color c2)))
		(index alpha2 (rbt uncle1 M4 N4 C4))
	...
	(= N5 (ite (= c5 0) N10 (+ N10 1)) ) (<= 0 c3) (<= c3 1) (=> (= c3 0) (and (= c5 1) (= C5 1)) ) 
