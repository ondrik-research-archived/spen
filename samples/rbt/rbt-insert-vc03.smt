...
(assert 
	...
	(=> (= c4 0) (and (= C5 1) (= C7 1)) ) (< (bagunion (bag d4) M5 M7)) (bag d3)) (< (bag d3) M6) 
	(<= 0 C1) (<= C1 1) (= N6 (ite (= c4 0) N7 (+ N7 1))) (=> (= C1 0) (and (= c4 1) (= C6 1))
	(= M1 (bagunion (bag d3) M6 (bag d4) M5 M7)) (= N1 (ite (= C1 0) N6 (+ N6 1)) ) (< key d2) (< d2 M4) 
	...
	(distinct parent0 nil) (= is_even 1) (distinct parent0 root) (= ggrandpa root)
	(= grandpa X) (= parent U1) (= cur U2) (= cusnode grandpa) (= cusparent ggrandpa)
	)
)
...
(assert (not 
	...
	(ssep 
		...
		(index alpha2 (rbt uncle M6 N6 C6))
		(pto parent (sref (ref left cur) (ref right V) (ref data d4) (ref color c4)))
		(index alpha3 (rbthole cur parent0 M5 N5 C5 M2 N2 C2)) 
		(index alpha4 (rbt V M7 N7 C7))
		(pto parent0 (sref (ref left x) (ref right Z) (ref data d2) (ref color C2)))
		(pto (rbt Z M4 N4 C4)) (pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color 0)))
	))
	(< key d2) (< (bag d2) M4)
	(= N4 1) (<= 0 C2) (<= C2 1) (=> (= C2 0) (= C4 1)) 
	(= M2 (bagunion (bag d2) (bag key) M4)) 
	(= N2 (ite (= C2 0) N4 (+ N4 1))) (< M5 (bag d4)) (< (bag d4) M7) (= N5 N7) 
	(<= 0 c4) (<=c4 1) (=> (= c4 0) (and (= C5 1) (= C7 1)) ) (< (bagunion (bag d4) M5 M7) (bag d3)) (< (bag d3) M6)
	(<=0 C1) (<= C1 1) (= N6 (ite (= c4 0) N7 (+ N7 1)) 
	(=> (= C1 0) (and (= c4 1) (= C6 1)) ) (< (bagunion (bag d4) M5 M7 (bag d3) M6) (bag d1)) ((bag d1) M3) 
	(= c1 1) (= N3  (ite (= C1 0) N6 (+ N6 1))) (= (bagunion M0 (bag key)) (bagunion (bag d4) M5 M7 (bag d3) M6 (bag d1) M3))
	(M0 = (bagminus M0 (bag key)) (distinct parent0 nil) (distinct parent0 root) (= ggrandpa root) (= cusnode grandpa)
