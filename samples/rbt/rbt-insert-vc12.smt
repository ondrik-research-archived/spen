...
(assert 
	...
	(ssep 
		...
		(pto cu2 (sref (ref left ggra) (ref right U) (ref data d4) (ref color c4)) )
		(index alpha6 (rbt U M8 N8 C8) )
		(pto ggra (sref (ref left ggrandpa1) (ref right V) (ref data d5) (ref color c5)) )
		(index alpha7 (rbt V M9 N9 C9) ) 
		(pto ggrandpa1 (sref (ref left grandpa1) (ref right unc) (ref data d6) (ref color c6)) )
		(index alpha8 (rbt unc M10 N10 C10) )
		(pto grandpa1 (sref (ref left parent1) (ref right uncle1) (ref data d7) (ref color c7)) )
		(index alpha9 (rbt uncle1 M11 N11 C11) ) 
		(pto parent1 (sref (ref left cur1) (ref right V1) (ref data d9) (ref color C12)) )
		(index alpha11 (rbt V1 M17 N17 C17) ) 
		(pto cur1 (sref (ref left U2) (ref right V2) (ref data d10) (ref color c10)) )
		(index alpha11 (rbt V2 M19 N19 C19))
		(index alpha10 (rbthole U2 parent0 M18 N18 C18 M13 N13 C13) )
	...
	(= M16 (bagunion M18 (bag d10) M19) ) (< M18 (bag d10)) (< (bag d10) M19)
	(= N16 (ite (= c10 0) N18 (+ N18 1) ) ) (= N18 N19) 
	(=> (= c10 0) (= C18 1)) (=> (= c10 0) (= C19 1) ) 
	(< M16 (bag d9)) (< (bag d9) M17) (= N16 N17) (<= 0 C12) (<= C12 1)
	(=> (= C12 0) (= c10 1) ) (=> (= C12 0) (= C17 1) ) (= M12 (bagunion M16 (bag d9) M17) )
	...
	(distinct cusparent1 nil)
	(= iseven 0) (= c5 0) (= C8 0) (= c6 1) (= C9 1)  (= c7 0) (= C10 0) (= cusparent2 cusparent1) (= cusnode2 cusnode1)
	(= ggrandpa2 grandpa1) (= grandpa2 parent1) (= uncle2 V1) (= parent2 cur1) (= cur2 U2)  (= c9 0)
	)
)
...
(assert 
	...
	(tobool 
	(ssep 
		(index alpha1 (rbthole root cusparent2 M1 N1 C1 M2 N2 C2))
		...
		(pto pa (sref (ref left cu1) (ref right U1) (ref data d3) (ref color c3)) )
		(index alpha4 (rbt U1 M5 N5 C5) ) 
		(index alpha5 (brrbthole cu1 ggrandpa1 M6 N6 C6 M20 N20 C20) )
		(pto ggrandpa1 (sref (ref left ggrandpa2) (ref right unc) (ref data d6) (ref color c6)) )
		(index alpha8 (rbt unc M10 N10 C10) )
		(pto ggrandpa2 (sref (ref left grandpa2) (ref right uncle1) (ref data d7) (ref color c7)) )
		(index alpha9 (rbt uncle1 M11 N11 C11) ) 
		(pto grandpa2 (sref (ref left parent2) (ref right uncle2) (ref data d9) (ref color C12)) )
		(index alpha11 (rbt uncle2 M17 N17 C17) ) 
		(pto parent2 (sref (ref left cur2) (ref right V2) (ref data d10) (ref color c10)) )
		(index alpha11 (rbt V2 M19 N19 C19))
		(index alpha10 (rbthole cur2 parent0 M18 N18 C18 M13 N13 C13) )
		(pto parent0 (sref (ref left x) (ref right Z) (ref data d8) (ref color c8)) )
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c9)) )
		(index alpha12 (rbt Z M14 N14 C14) )
	))
	(= M20 (bagunion M12 (bag d7) M11 (bag d6) M10) ) (= N20 (+ N10 1) ) (= C20 c6)
	(= M16 (bagunion M18 (bag d10) M19) ) (< M18 (bag d10)) (< (bag d10) M19)
	(= N16 (ite (= c10 0) N18 (+ N18 1) ) ) (= N18 N19) 
	(=> (= c10 0) (= C18 1)) (=> (= c10 0) (= C19 1) ) 
	(< M16 (bag d9)) (< (bag d9) M17) (= N16 N17) (<= 0 C12) (<= C12 1)
	...
	(= N2 (ite (= c1 0) N3 (+ N3 1)) ) (= C2 c1) (= M1 (bagunion M0 (bag key)) )
	(= M0 (bagminus M0 (bag key)) ) (distinct parent0 nil) (distinct parent0 root)
	(= iseven 0) (= c5 0) (= C8 0) (= c6 1) (= C9 1)  (= c7 0) (= C10 0) (= c9 0)
	)
))
