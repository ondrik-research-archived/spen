...
;; & C5=1) & M6 cup {d3} cup M5 < d2 < M4 & n3=N4 & n3 = ite(c3=0,N5,N5+1) & 0 <= c2 <= 1 & (c2=0=> c3=1 & C4=1) & M6 cup {d3} cup M5 
;; cup {d2} cup M4 < d1 < M3 & n2=N3 & n3 = ite(c2=0,N4,N4+1) & 0 <= c1 <= 1 & (c1=0=> c2=1 & C3=1) & M2 = M6 cup {d3} cup M5 cup {d2} 
...
(assert 
	...
	(= N12 N11) (<= 0 c7) (<=c7 1) (=> (= c7 0) (and (= C12 1) (= C11 1)) ) 
	(< (bagunion M12 (bag d7) M11) (bag d6) ) (< (bag d6) M10)
	(= M10 (ite (= c7 0) N11 (+ N11 1)) ) (<= 0 c6) (<=c6 1) (=> (= c6 0) (and (= c7 1) (= C10 1)) )
	...
	(=> (= c4 0) (and (= c5 1) (= C8 1)) ) (= M7 (bagunion M12 (bag d7) M11 (bag d6) M10 (bag d5) M9 (bag d4) M8) )
	...
	(= is_even 1) (= c5 0) (= C8 0) (= c7 0) (= C10 0)
	(= ggrandpa2 grandpa1) (= grandpa2 parent1) (= uncle2 W) (= parent2 cur1) (= cur2 U2) 
	)
)
...
(assert (not 
	...
	(ssep 
		...
		(pto cusparent2 (sref (ref left cusnode1) (ref right X) (ref data d1) (ref color c1))) 
		(index alpha14 (rbt X M3 N3 C3)) (pto cusnode2 (sref (ref left pa) (ref right Y) (ref data d2) (ref color c2)))
		...
		(pt parent0 (sref (ref left x) (ref right Z) (ref data d8) (ref color c8)))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color 0)))
		(index alpha23 (rbt Z M14 N14 C14))
	))
	(< M16 (bag d9))  (< (bag d9) M17) (= N16 N17) (<= 0 C12) (<= C12 1) (=> (= C12 0) (and (= C16 1) (= C17 1)) )
	...
	(<= 0 c7) (<= c7 1) (=> (= c7 0) (and (= C12 1) (= C11 1)) ) 
