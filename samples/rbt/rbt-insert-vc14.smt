...
(assert 
	...
	(ssep 
		...
		(index alpha3 (rbrbthole gra grandpa1 M4 N4 0 M5 N5 0))
		(pto grandpa1 (sref (ref left X) (ref right Y) (ref data d3) (ref color 0)))
		(index alpha4 (rbt Y M8 N8 1) 
		(pto X (sref (ref left U) (ref right V) (ref data d4) (ref color 1)))
		(index alpha5 (brrbthole U x M7 N7 1 M6 N6 1))
		(index alpha6 (rbt V M9 N9 1))
...
(assert (not 
	...
	(ssep 
		...
		(index alpha9 (rbrbthole gra grandpa2 M4 N4 0 M7 N7 0))
		(index alpha10 (brrbthole grandpa2 x M7 N7 1 M6 N6 1))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color 0)))
	))
	(= M6 (bag key)) (= N6 1) (< M4 (bag d2)) (< (bag d2) M3)
	...
	(=> (= c1 0) (and (= c2 1) (= C2 1)) ) 
	(= (bagunion M0 (bag key)) (bagunion (bag d2) M4  M3 (bagunion d1) M2) )
	(=  M0 (bagminus M0 (bag key)) (= cusparent nil)
	)
))
