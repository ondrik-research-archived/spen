...
;; VC14:
;; cusnode |-> ((left,pa),(right,unc),(data,d1),(color,c1)) * rbt(unc,M2,N2,C2) * pa |-> ((left,gra),(right,X),(data,d2),(color,c2)) * rbt(X,M3,N3,C3) * 
;; rbrbthole(gra,grandpa1,M4,N4,0,M5,N5,0) * grandpa1|-> ((left,X),(right,Y),(data,d3),(color,0)) * rbt(Y,M8,N8,1)  * X|-> ((left,U),(right,V),(data,d4),(color,1)) *
;; brrbthole(U,x,M7,N7,1,M6,N6,1) * rbt(V,M9,N9,1) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) & 
;; M7 < d4 < M9 & N7 = N9 & M7 cup {d4} cup M9 < d3 < M8 & N9 = N8 & M5 = M7 cup {d4} cup M9 cup {d3} cup M8 & N5 = N8+1 & M6 = {key} & N6 = 1 & M4 < d2 < M3 & N4 = N3 
;; & 0 <= c2 <= 1 & (c2 =0 => C3 =1) & {d2} cup M4 cup M3 < d1 < M2 & n2 = ite(c2 =0, N3, N3+1) & n2=N2 & 0 <=c1 <= 1 & (c1=0 => c2 = 1 & C2=1) & M0 cup {key} = {d2} 
;; cup M4 cup M3 cup {d1} cup M2 & ! key in M0 & cusparent = nil & grandpa2 = U
;; |-
;; cusnode |-> ((left,pa),(right,unc),(data,d1),(color,c1)) * rbt(unc,M2,N2,C2) * pa |-> ((left,gra),(right,X),(data,d2),(color,c2)) * rbt(X,M3,N3,C3) * 
;; rbrbthole(gra,grandpa2,M4,N4,0,M7,N7,0) * brrbthole(grandpa2,x,M7,N7,1,M6,N6,1) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) & M6 = {key} & N6 = 1 & 
;; M4 < d2 < M3 & N4 = N3 & 0 <= c2 <= 1 & (c2 =0 => C3 =1) & {d2} cup M4 cup M3 < d1 < M2 & n2 = ite(c2 =0, N3, N3+1) & n2=N2 & 0 <=c1 <= 1 & (c1=0 => c2 = 1 & C2=1) 
;; & M0 cup {key} = {d2} cup M4 cup M3 cup {d1} cup M2 & ! key in M0 & cusparent = nil
...
(assert 
	...
	(tobool 
	(ssep 
		(pto cusnode (sref (ref left pa) (ref right unc) (ref data d1) (ref color c1)))
		(index alpha1 (rbt unc M2 N2 C2))
		(pto pa (sref (ref left gra) (ref right X) (ref data d2) (ref color c2)))
		(index alpha2 (rbt X M3 N3 C3)) 
		(index alpha3 (rbrbthole gra grandpa1 M4 N4 c6 M5 N5 c6))
		(pto grandpa1 (sref (ref left X) (ref right Y) (ref data d3) (ref color c3)))
		(index alpha4 (rbt Y M8 N8 C8)) 
		(pto X (sref (ref left U) (ref right V) (ref data d4) (ref color c4)))
		(index alpha5 (brrbthole U x M7 N7 c7 M6 N6 c7))
		(index alpha6 (rbt V M9 N9 C9))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c5)))
	))
	(< M7 (bag d4)) (< (bag d4) M9) (= N7 N9) (< (bagunion M7 (bag d4) M9) (bag d3)) (< (bag d3) M8)
	(= N9 N8) (= M5 (bagunion M7 (bag d4) M9 (bag d3) M8) ) (= N5  (+ N8 1)) 
	(= M6 (bag key)) (= N6 1) (< M4 (bag d2)) (< (bag d2) M3)
	(= N4 N3) (<= 0 c2) (<= c2 1) (=> (= c2 0) (= C3 1)) (< (bagunion (bag d2) M4 M3) (bag d1)) (< (bag d1) M2)
	...
	(= cusparent nil) (= grandpa2 U) (= c3 0) (= c4 1) (= c5 0) (= c6 0) (= c7 1) (= C8 1) (= C9 1)
	)
)
...
(assert (not 
	...
	(ssep 
		(pto cusnode (sref (ref left pa) (ref right unc) (ref data d1) (ref color c1)))
		(index alpha7 (rbt unc M2 N2 C2)) 
		(pto pa (sref (ref left gra) (ref right X) (ref data d2) (ref color c2))) 
		(index alpha8 (rbt X M3 N3 C3))	
		(index alpha9 (rbrbthole gra grandpa2 M4 N4 c8 M7 N7 c8))
		(index alpha10 (brrbthole grandpa2 x M7 N7 c7 M6 N6 c7))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c5)))
	))
	(= M6 (bag key)) (= N6 1) (< M4 (bag d2)) (< (bag d2) M3)
	(= N4 N3) (<= 0 c2) (<= c2 1) (=> (= c2 0) (= C3 1))
	(< (bagunion (bag d2) M4 M3) (bag d1)) (< (bag d1) M2) 
	(= N2 (ite (= c2 0) N3 (+ N3 1)) ) (<= 0 c1) (<= c1 1)
	(=> (= c1 0) (= c2 1) ) (=> (= c1 0) (= C2 1) ) 
	(= (bagunion M0 (bag key)) (bagunion (bag d2) M4  M3 (bag d1) M2) )
	(=  M0 (bagminus M0 (bag key)) ) (= cusparent nil) (= c7 1) (= c8 0) (= c5 0)
	)
))
