...
(assert 
	...
	(ssep 
		...
		(index alpha5 (rbrbthole gra x M6 N6 C6 M7 N7 C7))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c4))) 
	))
	...
	(<= 0 c1) (<= c1 1) (=> (= c1 0) (= c2 1) ) (=> (= c1 0) (= C3 1) ) (= C2 c1) 
	(= M2 (bagunion (bag d3) M6 M5 (bag d2) M4 (bag d1) M3) )
	(= N2 (ite (= c1 0) N3 (+ N3 1)) ) (= M0 (bagminus M0 (bag key)) )
	(distinct cusparent nil) (= c2 0) (= c3 1) (= C4 1) (= ret root) (= C6 0) (= C7 0) (= c4 0)
	)
)
