...
;; cusnode |-> ((left,pa),(right,unc),(data,d2),(color,c2)) * rbt(unc,M4,N4,C4) * pa |-> ((left,gra),(right,Y),(data,d3),(color,c3)) *
;; rbt(Y,M5,N5,C5) * rbrbthole(gra,x,M6,N6,0,M7,N7,0) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) & M9 = {key} & N9 = 1 & 
;; M6 < d3 < M5 & N6 = N5 & 0 <= c3 <= 1 & (c3 =0 => C5 =1) & {d3} cup M6 cup M5 < d2 < M4 & n3 = ite(c3 =0, N5, N5+1) & n3=N4 &
;; 0 <=c2 <= 1 & (c2=0 => c3 = 1 & C4=1) & {d3} cup M6 cup M5 cup {d2} cup M4 < d1 < M3 & n2 = ite(c2 = 0, N4, N4+1) & n2=N3 & 
;; 0 <=c1 <= 1 & (c1=0 => c2 = 1 & C3=1) & C2 = c1 & M2 = {d3} cup M6 cup M5 cup {d2} cup M4 cup {d1} cup M3 & 
;; N2 = ite(c1=0, N3, N3+1) & ! key in M0 & ! cusparent = nil & c2=0 & c3 = 1 & C4 = 1 & ret = root
;; |-
...
(assert 
	...
	(ssep 
		...
		(index alpha5 (rbrbthole gra x M6 N6 0 M7 N7 0))
	...
	(= N4 (ite (= c3 0) N5 (+ N5 1)) )
	(<= 0 c2) (<= c2 1) (=> (= c2 0) (and (= c3 1) (= C4 1))) (< (bagunion (bag d3) M6  M5 (bag d2) M4) (bag d1))
	(< (bag d1) M3) (= N3 (ite (= c2 0) N4 (+ N4 1)) ) 
	(<= 0 c1) (<= c1 1) (=> (= c1 0) (and (= c2 1) (= C3 1)) ) (= C2 c1) (= M2 (bagunion (bag d3) M6 M5 (bag d2) M4 (bag d1) M3) )
	(= N2 (ite (= c1 0) N3 (+ N3 1)) ) (= M0 (bagminus M0 (bag key)) )
	(distinct cusparent nil) (= c2 0) (= c3 1) (= C4 1) (= ret root)
	)
)
