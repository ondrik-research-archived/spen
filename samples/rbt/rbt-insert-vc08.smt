...
(assert 
	...
	(tobool 
	(ssep 
		(index alpha0 (rbthole root cusparent1 M1 N1 C1 M2 N2 C2) )
		(pto cusparent1 (sref (ref left cusnode1) (ref right X) (ref data d1) (ref color c1)) )
		(index alpha00 (rbt X M3 N3 C3))
		...
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color c8)) )
	...
	(= N8 (ite (= c5 0) N9 (+ N9 1)) ) (<= 0 c4) (<= c4 1) (=> (= c4 0) (= c5 1) ) ( => (= c4 0) (= C8 1))
...
(assert (not 
	...
	(distinct parent0 nil) (distinct parent0 root) (distinct cusparent2 nil) (= iseven 1) 
	(>= (+ c7 C10) 1) (= grandpa2 parent0) (= parent2 x) (= uncle2 Z) (= cur2 nil) (= c8 0)
	)
))
