...
;; rbt(U,M8,N8,C8) * ggrandpa1 |-> ((left,grandpa1),(right,V),(data,d5),(color,c5)) * rbt(V,M9,N9,C9) * 
;; grandpa1 |-> ((left,parent0),(right,uncle1),(data,d6),(color,c6)) * rbt(uncle1,M10,N10,C10) * parent0 |-> ((left,x),(right,Z),
;; (data,d7),(color,c7)) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) * rbt(Z,M11,N11,C11) 
...
;; M6 cup {d3} cup M5 < d2 < M4 & n3=N4 & n3 = ite(c3=0,N5,N5+1) & 0 <= c2 <= 1 & (c2=0=> c3=1 & C4=1) & M6 cup {d3} cup M5 
;; cup {d2} cup M4 < d1 < M3 & n2=N3 & n3 = ite(c2=0,N4,N4+1) & 0 <= c1 <= 1 & (c1=0=> c2=1 & C3=1) & M2 = M6 cup {d3} cup M5 
;; cup {d2} cup M4 cup {d1} cup M3 & N2 = ite(c1=0,N3,N3+1) & C2=c1 & M1 = M0 cup {key} & !key in M0 &  ! parent0 = nil & 
;; ! parent0 = root & ! cusparent1 = nil & is_even = 0 & c5 = 1 & C8 =0 & (c7 = 1 | C10 = 1) & parent1=parent0 & cur1 = x & 
;; cusnode2 = grandpa1 & cusparent2 = ggrandpa1 & ggrandpa2 = grandpa1 & grandpa2 = parent1 & uncle2 = Z & parent2 = cur1 & 
;; cur2 = nil
;; |-
;; rbthole(root,cusparent2,M1,N1,C1,M12,N12,C12) * cusparent2 |-> ((left,cusnode2),(right,V),(data,d5),(color,c5)) * 
;; rbt(V,M9,N9,C9) * cusnode2 |-> ((left,parent0),(right,uncle1),(data,d6),(color,c6)) * rbt(uncle1,M10,N10,C10) * 
;; parent0 |-> ((left,x),(right,Z),(data,d7),(color,c7)) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) * 
;; rbt(Z,M11,N11,C11) 
;; & key < d7 < M11 & N11 = 1 & 0<=c7<=1 & (c7 = 0 => C11 = 1) & {key} cup {d7} cup M11 < d6 < M10 & n7 = ite(c7=0,N11,N11+1) 
;; & n7=N10 & 0<=c6 <=1 & (c6 =0 => c7 = 1 & C10 =1) & {key} cup {d7} cup M11 cup {d6} cup M10 < d5 < M9 & n6 = ite(c6=0,N10,N10+1)
;; & n6=N9 & 0<=c5 <=1 & (c5 =0 => c6 = 1 & C9 =1) & M12 = {key} cup {d7} cup M11 cup {d6} cup M10 cup {d5} cup M9 & 
;; N12 = ite(c5=0,N9,N9+1) & C12=c5 & M1 = M0 cup {key} & !key in M0 & ! parent0 = nil & ! parent0 = root & ! cusparent2 = nil & 
;; is_even = 1 & (c7 = 1 | C10 = 1) & grandpa2=parent0 & parent2 = x & uncle2 = Z & cur2 = nil
...
(assert 
	...
	(ssep 
		...
		(index alpha7 (rbt Z M11 N11 C11)) 
	))
	(< key d7) (< (bag d7) M11) (= N11 1) (<= 0 c7) (<=c7 1) (=> (= c7 0) (= C11 1) ) 
	(< (bagunion (bag key) (bag d7) M11) (bag d6)) (< (bag d6) M10) 
	(= N10 (ite (= c7 0) N11 (+ N11 1)) ) (<= 0 c6) (<=c6 1) 
	(=> (= c6 0) (and (= c7 1) (= C10 1)) ) (< (bagunion (bag (key) (bag d7) M11 (bag d6) M10) (bag d5)) (< (bag d5) M9)
	...
	(< (bagunion M6 (bag d3) M5 (bag d2) M4) (bag d1)) (< (bag d1) M3)  (= N3 (ite (=c2 0) N4 (+ N4 1)) ) 
	(<= 0 c1) (<= c1 1) (=> (= c1 0) (and (= c2 1) (= C3 1)) ) 
	(= M2 (bagunion M6 (bag d3) M5 (bag d2) M4 (bag d1) M3) ) (= N2 (ite (= c1 0) N3 (+ N3 1))) 
	(= C2 c1) (= M1  (bagunion M0  (bag key)) ) (=  M0 (bagminus M0 (bag key))) (distinct parent0 nil)
	(distinct parent0 root) (distinct cusparent1 nil) (= is_even 0) (= c5 1) (= C8 0) (>= (+ c7 C10) 1) 
	(= parent1 parent0) (= cur1 x) (= cusnode2 grandpa1) (= cusparent2 ggrandpa1) (= ggrandpa2 grandpa1)
...
(assert (not 
	...
	(tobool 
	(ssep 
		(index alpha8 (rbthole root cusparent2 M1 N1 C1 M12 N12 C12))
		(pto cusparent2 (sref (ref left cusnode2) (ref right V) (ref data d5) (ref color c5)))
		(index alpha9 (rbt V M9 N9 C9)) 
		(pto cusnode2 (sref (ref left parent0) (ref right uncle1) (ref data d6) (ref color c6)))
		(index alpha10 (rbt uncle1 M10 N10 C10))
		(pto parent0 (sref (ref left x) (ref right Z) (ref data d7) (ref color c7)))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color 0))) 
		(index alpha11 (rbt Z M11 N11 C11)) 
	))
	(< key d7) (< (bag d7) M11) (= N11 1) (<= 0 c7) (<= c7 1) (=> (= c7 0) (= C11 1))
	(< (bagunion (bag key) (bag d7) M11) (bag d6)) (< (bag d6) M10) 
	(= N10 (ite (= c7 0) N11 (+ N11 1)) ) (<= 0 c6) (<= c6 1) 
	...
	(= N12 (ite (= c5 0) N9 (+ N9 1)) ) (= C12 c5) 
	(= M1 (bagunion M0 (bag key) (= M0 (bagminus M0 (bag key))) 
	(distinct parent0 nil) (distinct parent0 root) (distinct cusparent2 nil) (= is_even 1) 
	(>= (+ c7 C10) 1) (= grandpa2 parent0) (= parent2 x) (= uncle2 Z) (= cur2 nil)
	)
))
