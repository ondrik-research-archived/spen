...
;; rbt(X,M3,N3,C3) * cusnode1 |-> ((left,pa),(right,Y),(data,d2),(color,c2)) * rbt(Y,M4,N4,C4) * pa|-> ((left,cu1),
;; (right,Z),(data,d3),(color,c3)) * rbt(Z,M5,N5,C5) * brrbthole(cu1,cu2,M6,N6,C6,M7,N7,C7) * cu2 |-> 
;; ((left,ggrandpa1),(right,U),(data,d4),(color,c4)) * rbt(U,M8,N8,C8) * ggrandpa1 |-> ((left,grandpa1),(right,V),
;; (data,d5),(color,c5)) * rbt(V,M9,N9,C9) * grandpa1 |-> ((left,parent1),(right,uncle1),(data,d6),(color,c6)) * 
;; rbt(uncle1,M10,N10,C10) * parent1 |-> ((left,cur1),(right,W),(data,d7),(color,c7)) * rbt(W,M11,N11,C11) * 
;; cur1|-> ((left,U1),(right,V1),(data,d9),(color,C12)) * rbthole(U1,parent0,M16,N16,C16,M13,N13,C13) * 
;; rbt(V1,M17,N17,C17) * parent0 |-> ((left,x),(right,Z),(data,d8),(color,c8)) * x |-> ((left,nil),(right,nil),
;; (data,key),(color,0)) * rbt(Z,M14,N14,C14) 
;; & 
;; M16 < d9 < M17 & N16 = N17 & 0<= C12 <= 1 & (C12 =0=> C16 =1 & C17 = 1) & M12 = M16 cup {d9} cup M17 & 
;; N12=ite(C12=0,N17,N17+1) & key < d8 < M14 & N14 = 1 & 0<=c8<=1 & (c8 = 0 => C14 = 1) & M13 = {d8} cup {key} 
;; cup M14 & N13 = ite(c8=0,N14,N14+1) & C13= c8 & M12 < d7 < M11 & N12 = N11 & 0<=c7<=1 & (c7=0 => C12 = 1 & 
;; C11 = 1) & M12 cup {d7} cup M11 < d6 < M10 & n7 = ite(c7=0,N11,N11+1) & n7=N10 & 0<=c6 <=1 & (c6 =0 => c7 = 1 &
;; C10 =1) & M12 cup {d7} cup M11 cup {d6} cup M10 < d5 < M9 & n6 = ite(c6=0,N10,N10+1) & n6=N9 & 0<=c5 <=1 & (c5 =0 
;; => c6 = 1 & C9 =1) & M12 cup {d7} cup M11 cup {d6} cup M10 cup {d5} cup M9 < d4 < M8 & n5 = ite(c5=0,N9,N9+1) &
;; n5=N8 & 0<=c4 <=1 & (c4 =0 => c5 = 1 & C8 =1) & M7 = M12 cup {d7} cup M11 cup {d6} cup M10 cup {d5} cup M9
;; cup {d4} cup M8 & N7 = ite(c4=0,N8,N8+1) & C7 = c4 & M6 < d3 < M5 & N6=N5 & 0 <= c3 <= 1 & (c3=0=> C6=1 & C5=1) &
;; M6 cup {d3} cup M5 < d2 < M4 & n3=N4 & n3 = ite(c3=0,N5,N5+1) & 0 <= c2 <= 1 & (c2=0=> c3=1 & C4=1) & M6 cup {d3}
;; cup M5 cup {d2} cup M4 < d1 < M3 & n2=N3 & n3 = ite(c2=0,N4,N4+1) & 0 <= c1 <= 1 & (c1=0=> c2=1 & C3=1) & 
;; M2 = M6 cup {d3} cup M5 cup {d2} cup M4 cup {d1} cup M3 & N2 = ite(c1=0,N3,N3+1) & C2=c1 & M1 = M0 cup {key} & 
;; !key in M0 & ! parent0 = nil & ! parent0 = root & ! cusparent1 = nil & is_even = 1 & (c7 = 1 | C10 = 1) & 
;; cusnode2 = grandpa1 & cusparent2 = ggrandpa1 & ggrandpa2 = grandpa1 & grandpa2 = parent1 & uncle2 = W & 
;; parent2 = cur1 & cur2 = U1
;; |-
;; rbthole(root,cusparent2,M1,N1,C1,M15,N15,C15) * cusparent2 |-> ((left,cusnode2),(right,V),(data,d5),(color,c5)) *
;; rbt(V,M9,N9,C9) * cusnode2 |-> ((left,grandpa2),(right,uncle1),(data,d6),(color,c6)) * rbt(uncle1,M10,N10,C10) *
;; grandpa2 |-> ((left,parent2),(right,uncle2),(data,d7),(color,c7)) * rbt(uncle2,M11,N11,C11) * 
;; parent2|-> ((left,cur2),(right,V1),(data,d9),(color,C12)) * rbthole(cur2,parent0,M16,N16,C16,M13,N13,C13) * 
;; rbt(V1,M17,N17,C17) * parent0 |-> ((left,x),(right,Z),(data,d8),(color,c8)) * x |-> ((left,nil),(right,nil),
;; (data,key),(color,0)) * rbt(Z,M14,N14,C14)
;; & M16 < d9 < M17 & N16 = N17 & 0<= C12 <= 1 & (C12 =0=> C16 =1 & C17 = 1) & key < d8 < M14 & N14 = 1 & 0<=c8<=1 & 
;; (c8 = 0 => C14 = 1) & M13 = {d8} cup {key} cup M14 & N13 = ite(c8=0,N14,N14+1) & C13= c8 & M16 cup {d9} cup 
;; M17 < d7 < M11 & n9 = N11 & n9 = ite(C12=0,N17,N17+1) & 0<=c7<=1 & (c7=0 => C12 = 1 & C11 = 1) & M16 cup {d9} 
;; cup M17 cup {d7} cup M11 < d6 < M10 & n7 = ite(c7=0,N11,N11+1) & n7=N10 & 0<=c6 <=1 & (c6 =0 => c7 = 1 & C10 =1) &
;; M16 cup {d9} cup M17 cup {d7} cup M11 cup {d6} cup M10 < d5 < M9 & n6 = ite(c6=0,N10,N10+1) & n6=N9 & 0<=c5 <=1 &
;; (c5 =0 => c6 = 1 & C9 =1) & M15 = M16 cup {d9} cup M17 cup {d7} cup M11 cup {d6} cup M10 cup {d5} cup M9 & 
;; N15 = ite(c5=0,N9,N9+1) & C15=c5 & M1 = M0 cup {key} & !key in M0 & ! parent0 = nil & ! parent0 = root & 
...
(assert 
	...
	(ssep 
		...
		(index alpha3 (rbt Y M4 N4 C4)) (pto pa (sref (ref left cu1) (ref right Z) (ref data d3) (ref color c3)))
		(index alpha4 (rbt Z M5 N5 C5)) (index alpha5 (brrbthole cu1 cu2 M6 N6 C6 M7 N7 C7))
		(pto cu2 (sref (ref left ggrandpa1) (ref right U) (ref data d4) (ref color c4)))
		(index alpha5 (rbt U M8 N8 C8)) 
		(pto ggrandpa1 (sref (ref left grandpa1) (ref right V) (ref data d5) (ref color c5)))
		(index alpha6 (rbt V M9 N9 C9)) 
		(pto grandpa1 (sref (ref left parent1) (ref right uncle1) (ref data d6) (ref color c6)))
		(index alpha7 (rbt uncle1 M10 N10 C10)) 
		(pto parent1 (sref (ref left cur1) (ref right W) (ref data d7) (ref color c7)))
		(index alpha8 (rbt W M11 N11 C11)) 
		(pto cur1 (sref (ref left U1) (ref right V1) (ref data d9) (ref color C12)))
	...
	(< M16 d9) (< d9 M17) (= N16 N17) (<= 0 C12) (<= C12 1)
	(=> (= C12 0) (and (= C16 1) (= C17 1)) ) (= M12 (bagunion M16 (bag d9) M17) ) 
	(= N12 (ite (= C12 0) N17 (+ N17 1)) ) (< key d8) (< d8 M14) (= N14 1)
	(<= 0 c8) (<=c8 1) (=> (= c8 0) (= C14 1) ) 
	(= M13 (bagunion (bag d8) (bag key) M14) ) (= N13 (ite (= c8 0) N14 (+ N14 1)) )  
	(= C13 c8) (< M12 (bag d7)) (< (bag d7) M11) (= N12 N11) (<= 0 c7) (<=c7 1) 
	(=> (= c7 0) (and (= C12 1) (= C11 1)) ) (< (bagunion M12 (bag d7) M11) (bag d6)) (< (bag d6) M10) 
	(= N10 (ite (= c7 0) N11 (+ N11 1)) ) (<= 0 c6) (<=c6 1) (=> (= c6 0) (and (= c7 1) (= C10 1)) )
	(< (bagunion M12 (bag d7) M11 (bag d6) M10) (bag d5)) (< (bag d5) M9) 
	(= N9 (ite (= c6 0) N10 (+ N10 1)) ) (<= 0 c5) (<=c5 1)
	(=> (= c5 0) (and (= c6 1) (= C9 1)) ) (< (bagunion M12 (bag d7) M11 (bag d6) M10 (bag d5) M9) (bag d4)) 
	(< (bag d4) M8) (= N8  (ite (= c5 0) N9 (+ N9 1)) )  (<= 0 c4) (<= c4 1)
	(=> (= c4 0) (and (= c5 1) (= C8 1)) ) 
	(= M7 (bagunion M12 (bag d7) M11 (bag d6) M10 (bag d5) M9 (bag d4) M8) ) 
	(= N7 (ite (= c4 0) N8 (+ N8 1)) ) (= C7 c4) (< M6 (bag d3)) (< (bag d3) M5) (= N6 N5) 
	(<= 0 c3) (<= c3 1) (=> (= c3 0) (and (= C6 1) (= C5 1)) ) 
	(< (bagunion M6 (bag d3) M5) (bag d2)) (< (bag d2) M4) (= N4 (ite (= c3 0) N5 (+ N5 1)) ) 
	(<= 0 c2) (<= c2 1) (=> (= c2 0) (and (= c3 1) (= C4 1)) )
	...
	(= is_even 1) (>= c7+C10 1) (= cusnode2 grandpa1)  (= cusparent2 ggrandpa1) (= ggrandpa2 grandpa1)
	(= grandpa2 parent1) (= uncle2 W) (= parent2 cur1) (= cur2 U1)
	)
)
...
(assert (not 
	...
	(tobool 
	(ssep 
		(index alpha12 (rbthole root cusparent2 M1 N1 C1 M15 N15 C15))
		(pto cusparent2 (sref (ref left cusnode2) (ref right V) (ref data d5) (ref color c5))) 
		(index alpha13 (rbt V M9 N9 C9)) 
		(pto cusnode2 (sref (ref left grandpa2) (ref right uncle1) (ref data d6) (ref color c6)) ) 
		(index alpha14 (rbt uncle1 M10 N10 C10)) 
		(pto grandpa2 (sref (ref left parent2) (ref right uncle2) (ref data d7) (ref color c7)))
		(index alpha15 (rbt uncle2 M11 N11 C11)) 
	...
	(=> (= C12 0) (and (= C16 1) (= C17 1)) ) (< key d8) (< (bag d8) M14)
	...
	(=> (= c7 0) (and (= C12 1) (= C11 1)) ) (< (bagunion M16 (bag d9) M17 (bag d7) M11) (bag d6)) 
	(< (bag d6) M10) (= N10 (ite (= c7 0) N11 (+ N11 1)) ) (<= 0 c6) (<= c6 1)
	(=> (= c6 0) (and (= c7 1) (= C10 1)) ) (< (bagunion M16  (bag d9) M17 (bag d7) M11 (bag d6) M10) (bag d5))
