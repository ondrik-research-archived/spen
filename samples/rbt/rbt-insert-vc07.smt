...
(assert 
	...
	(ssep 
		...
		(pto pa (sref (ref left cu1) (ref right Z) (ref data d3) (ref color c3)))
		(index alpha4 (rbt Z M5 N5 C5)) 
	...
	(= iseven 1) (>= (+ c7 C10) 1) (= cusnode2 grandpa1)  (= cusparent2 ggrandpa1) (= ggrandpa2 grandpa1)
