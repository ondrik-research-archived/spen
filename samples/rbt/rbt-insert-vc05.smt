...
VC05: rbthole(root,cusparent1,M1,N1,C1,M2,N2,C2) * cusparent1 |-> ((left,cusnode1),(right,X),(data,d1),(color,c1)) * 
;; rbt(X,M3,N3,C3) * cusnode1 |-> ((left, ggrandpa1),(right,Y),(data,d2),(color,c2)) * rbt(Y,M4,N4,C4) * 
;; ggrandpa1 |-> ((left,grandpa1),(right,U),(data,d3),(color,c3)) * rbt(U,M5,N5,C5) * grandpa1 |-> ((left,parent1),
;; (right, uncle1),(data,d4),(color,c4)) * rbt(uncle1,M6,N6,C6) * parent1|->((left,cur1),(right,V),(data,d5),
;; (color,c5)) * rbt(V,M7,N7,C7) * cur1|-> ((left,U1),(right,V1),(data,d7),(color,C8)) * rbthole(U1,parent0,M12,N12,
;; C12,M9,N9,C9) * rbt(V1,M13,N13,C13) * parent0 |-> ((left,x),(right,Z),(data,d6),(color,c6)) * x |-> ((left,nil),
;; (right,nil),(data,key),(color,0)) * rbt(Z,M10,N10,C10)
;; & M12 < d7 < M13 & N12 = N13 & 0<= C8 <= 1 & (C8=0 => C12=1 & C13=1) & M8 =  M12 cup d7 cup M13 & 
;; N8 = ite(C8=0,N13,N13+1) & key < d6 < M10 & N10=1 & 0<=c6<=1 & c6=0 => C10 = 1 & M9 = {d6} cup {key} cup M10 &
;; N9=ite(c6=0,N10,N10+1) & C9=c6 & M8 < d5 < M7 & N8 = N7 & 0<=c5 <= 1 & (c5 =0 => C8 = 1 & C7 = 1) & 
;; M8 cup {d5} cup M7 < d4 < M6 & n5=ite(c5=0, N7,N7+1) & n5 = N6 & 0<= c4 <= 1 & (c4=0 => c5 =1 & C6 = 1) & 
;; M8 cup {d5} cup M7 cup {d4} cup M6 < d3 < M5 & n4=ite(c4=0,N6,N6+1) & n4=N5 & 0 <=c3 <= 1 & (c3 =0 => c4 =1 & 
;; C5 = 1) & M8 cup {d5} cup M7 cup {d4} cup M6 cup {d3} cup M5 < d2 < M4 & n3=ite(c3=0,N5,N5+1) & n3=N4 & 
;; 0 <=c2 <= 1 & (c2 =0 => c3 =1 & C4 = 1) & M8 cup {d5} cup M7 cup {d4} cup M6 cup {d3} cup M5 cup {d2} cup 
;; M4 < d1 < M3 & n2=ite(c2=0,N4,N4+1) & n2=N3 & 0 <=c1 <= 1 & (c1 =0 => c2 =1 & C3 = 1) & M2 = M8 cup {d5} cup 
;; M7 cup {d4} cup M6 cup {d3} cup M5 cup {d2} cup M4 cup {d1} cup M3 & N2 = ite(c1=0,N3,N3+1) & C2= c1 & 
;; M0 cup {key} = M1 & ! key in M0 & ! parent0 = nil & ! parent0 = root & ! cusparent1 = nil & is_even = 1 & 
;; (c5 = 1 | C5 = 1) & parent2=cur1 & cur2 = U1 & cusparent2 = ggrandpa1 & cusnode2 = grandpa1 & ggrandpa2 = 
;; grandpa1 & grandpa2 = parent1 & uncle2 = V
;; |-
;; rbthole(root,cusparent2,M1,N1,C1,M11,N11,C11) * cusparent2 |-> ((left,cusnode2),(right,U),(data,d3),(color,c3)) * 
;; rbt(U,M5,N5,C5) * ggrandpa2 |-> ((left,grandpa2),(right, uncle1),(data,d4),(color,c4)) * rbt(uncle1,M6,N6,C6) *
;; grandpa2|->((left,parent2),(right,uncle2),(data,d5),(color,c5)) * rbt(uncle2,M7,N7,C7) * parent2|-> ((left,cur2),
;; (right,V1),(data,d7),(color,C8)) * rbthole(cur2,parent0,M12,N12,C12,M9,N9,C9) * rbt(V1,M13,N13,C13) * 
;; parent0 |-> ((left,x),(right,Z),(data,d6),(color,c6)) * x |-> ((left,nil),(right,nil),(data,key),(color,0)) * 
;; rbt(Z,M10,N10,C10)
;; & 
;; M12 < d7 < M13 & N12 = N13 & 0<= C8 <= 1 & (C8=0 => C12=1 & C13=1) & key < d6 < M10 & N10=1 & 0<=c6<=1 & c6=0 =>
;; C10 = 1 & M9 = {d6} cup {key} cup M10 & N9=ite(c6=0,N10,N10+1) & C9=c6 & M12 cup {d7} cup M13 < d5 < M7 & n7 = N7 
;; & n7=ite(C8=0,N13,N13+1) & 0<=c5 <= 1 & (c5 =0 => C8 = 1 & C7 = 1) & M12 cup {d7} cup M13 cup {d5} cup M7 < 
;; d4 < M6 & n5=ite(c5=0, N7,N7+1) & n5 = N6 & 0<= c4 <= 1 & (c4=0 => c5 =1 & C6 = 1) & M12 cup {d7} cup M13 cup {d5}
;; cup M7 cup {d4} cup M6 < d3 < M5 & n4=ite(c4=0,N6,N6+1) & n4=N5 & 0 <=c3 <= 1 & (c3 =0 => c4 =1 & C5 = 1) & M12 
;;cup {d7} cup M13 cup {d5} cup M7 cup {d4} cup M6 cup {d3} cup M5 < d2 < M4 & n3=ite(c3=0,N5,N5+1) & n3=N4 & 
;; 0 <=c2 <= 1 & (c2 =0 => c3 =1 & C4 = 1) & M12 cup {d7} cup M13 cup {d5} cup M7 cup {d4} cup M6 cup {d3} cup M5 
;; cup {d2} cup M4 < d1 < M3 & n2=ite(c2=0,N4,N4+1) & n2=N3 & 0 <=c1 <= 1 & (c1 =0 => c2 =1 & C3 = 1) & 
;; M2 = M12 cup {d7} cup M13 cup {d5} cup M7 cup {d4} cup M6 cup {d3} cup M5 cup {d2} cup M4 cup {d1} cup M3 & 
;; N2 = ite(c1=0,N3,N3+1) & C2= c1 & M0 cup {key} = M1 & ! key in M0 & ! parent0 = nil & ! parent0 = root & 
;; ! cusparent2 = nil & cusnode2 = ggrandpa2 & is_even = 1
...
(assert 
	...
	(ssep 
		...
		(pto cur1 (sref (ref left U1) (ref right V1) (ref data d7) (ref color C8)))
		(index alpha7 (rbthole U1 parent0 M12 N12 C12 M9 N9 C9))
		(index alpha8 (rbt V1 M13 N13 C13))
	...
	(=> (= C8 0) (and (= C12 1) (= C13 1)) ) (= M8 (bagunion M12 (bag d7) M13) ) (= N8 (ite (= C8 0) N13 (+ N13 1))) 
	(< key d6) (< (bag d6) M10) (= N10 1) (<= 0 c6) (<= c6 1) (= c6 0) (= C10 1) (= M9 (bagunion (bag d6) (bag key) M10))
	(= N9 (ite (= c6 0) N10 (+ N10 1))) (= C9 c6) (< M8 (bag d5)) (< (bag d5) M7) (= N8 N7) (<= 0 c5) (<= c5 1)
	(=> (= c5 0) (and (= C8 1) (= C7 1))) (< ((bagunion M8 (bag d5) M7) (bag d4)) (< (bag d4) M6) 
	(= N6 (ite (= c5 0) N7 (+ N7 1))) (<= 0 c4) (<= c4 1) (=> (= c4 0)  (and (= c5 1) (= C6 1)) ) 
	(< (bagunion M8 (bag d5) M7 (bag d4) M6) (bag d3)) (< (bag d3) M5) (= N5 (ite (= c4 0) N6 (+ N6 1))) 
	(<= 0 c3) (<= c3 1) (=> (= c3 0) (and (= c4 1) (= C5 1)) ) (< (bagunion M8 (bag d5) M7 (bag d4) M6 (bag d3) M5) (bag d2)) 
	(< (bag d4) M4) (= N4  (ite (= c3 0) N5 (+ N5 1)) ) (<= 0 c2) (<= c2 1) (=> (= c2 0) (and (= c3 1) (= C4 1)) )
	(< (bagunion M8 (bag d5)  M7 (bag d4) M6 (bag d3) M5 (bag d2) M4) (bag d1)) (< (bag d1) M3) (= N3 (ite (= c2 0) N4 (+ N4 1)) ) 
	(<= 0 c1) (<= c1 1) (=> (= c1 0) (and (= c2 1) (= C3 1) ) (= M2 (bagunion M8 (bag d5) M7 (bag d4) M6 (bag d3) M5 (bag d2) M4 (bag d1) M3)) (= N2  (ite (= c1 0) N3 (+ N3 1)) ) (= C2 c1) (= (bagunion M0 (bag key)) M1) 
	(= M0  (bagminus M0 (bag key)) ) (distinct parent0 nil) (distinct parent0 root) (distinct cusparent1 nil) (= is_even 1)
	(>= (+ c5 C5) 1) (= parent2 cur1) (= cur2 U1) (= cusparent2 ggrandpa1) (= cusnode2 grandpa1) (= ggrandpa2 grandpa1)
	(= grandpa2 parent1) (= uncle2 V)
	)
)
...
(assert (not 
	...
	(tobool 
	(ssep 
	(index alpha10 (rbthole root cusparent2 M1 N1 C1 M11 N11 C11))
	(pto cusparent2 (sref (ref left cusnode2) (ref right U) (ref data d3) (ref color c3)))
	(index alpha11 (rbt U M5 N5 C5))
	(pto ggrandpa2 (sref (ref left grandpa2) (ref right uncle1) (ref data d4) (ref color c4)))
	(index alpha12 (rbt uncle1 M6 N6 C6)) (pto grandpa2 (sref (ref left parent2) (ref right uncle2) (ref data d5) (ref color c5))) 	(index alpha13 (rbt uncle2 M7 N7 C7)) 
	(pto parent2 (sref (ref left cur2) (ref right V1) (ref data d7) (ref color C8)))
	(index alpha14 (rbthole cur2 parent0 M12 N12 C12 M9 N9 C9))
	(index alpha15 (rbt V1 M13 N13 C13))
	(pto parent0 (sref (ref left x) (ref right Z) (ref data d6) (ref color c6)))
	(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color 0)))
	(index alpha16 (rbt Z M10 N10 C10))
	))
	(< M12 (bag d7)) (< (bag d7) M13) (= N12 N13) (<= 0 C8) (<= C8 1) (=> (= C8 0) (and (= C12 1) (= C13 1)) ) 
	(< key d6) (< (bag d6) M10) (= N10 1) (<= 0 c6) (<=c6 1) (=> (= c6 0) (= C10 1) ) (= M9 (bagunion (bag d6) (bag key) M10))
	(= N9 (ite (= c6 0) N10 (+ N10 1)) ) (= C9 c6)  (< (bagunion M12 (bag d7) M13) (bag d5)) (< (bag d5) M7) 
	(= N7 (ite (= C8 0) N13 (+ N13 1)) ) (<= 0 c5) (<= c5 1) (=> (= c5 0) (and (= C8 1) (= C7 1)) )  
	(< (bagunion M12 (bag d7) M13 (bag d5) M7) (bag d4) ) (< (bag d4) M6) (= N6 (ite (= c5 0) N7 (+ N7 1)) )
	(<= 0 c4) (<= c4 1) (=> (= c4 0) (and (= c5 1) (= C6 1)) ) (< (bagunion M12 (bag d7) M13 (bag d5) M7 (bag d4) M6) (bag d3))
	(< (bag d3) M5) (= N5 (ite (= c4 0) N6 (+ N6 1)) ) (<= 0 c3) (<= c3 1) (=> (= c3 0) (and (= c4 1) (= C5 1)) ) 
