...
(assert 
	...
	(=> (= C8 0) (= C12 1) ) (=> (= C8 0) (= C13 1) ) (= M8 (bagunion M12 (bag d7) M13) ) (= N8 (ite (= C8 0) N13 (+ N13 1)) ) 
	...
	(< (bagunion M8 (bag d5) M7 (bag d4) M6 (bag d3) M5) (bag d2) ) 
	(< (bag d2) M4) (= N4  (ite (= c3 0) N5 (+ N5 1)) ) (<= 0 c2) (<= c2 1) (=> (= c2 0) (= c3 1) ) (=> (= c2 0) (= C4 1) )
	(< (bagunion M8 (bag d5) M7 (bag d4) M6 (bag d3) M5 (bag d2) M4) (bag d1)) (< (bag d1) M3) (= N3 (ite (= c2 0) N4 (+ N4 1)) ) 
	(<= 0 c1) (<= c1 1) (=> (= c1 0) (= c2 1) ) (=> (= c1 0) (= C3 1) ) 
	(= M2 (bagunion M8 (bag d5) M7 (bag d4) M6 (bag d3) M5 (bag d2) M4 (bag d1) M3) ) 
	(= N2  (ite (= c1 0) N3 (+ N3 1)) ) (= C2 c1) (= (bagunion M0 (bag key)) M1) 
	(= M0 (bagminus M0 (bag key)) ) (distinct parent0 nil) (distinct parent0 root) (distinct cusparent1 nil) (= iseven 1)
	(>= (+ c5 C5) 1) (= parent2 cur1) (= cur2 U1) (= cusparent2 ggrandpa1) (= cusnode2 grandpa1) (= ggrandpa2 grandpa1)
	(= grandpa2 parent1) (= uncle2 V) (= c7 0) (= M11 (bagunion M8 (bag d5) M7 (bag d4) M6 (bag d3) M5 ) ) 
	(= N11 (ite (= c3 0) N5 (+ N5 1) ) ) (= C11 c3)
	)
)
...
(assert (not 
	...
	(< M12 (bag d7)) (< (bag d7) M13) (= N12 N13) (<= 0 C8) (<= C8 1) 
	(=> (= C8 0) (= C12 1) ) ( => (= C8 0) (= C13 1) ) 
	(< key d6) (< (bag d6) M10) (= N10 1) (<= 0 c6) (<= c6 1) (=> (= c6 0) (= C10 1) ) 
	(= M9 (bagunion (bag d6) (bag key) M10) )
	...
	(<= 0 c4) (<= c4 1) (=> (= c4 0) (= c5 1) ) (=> (= c4 0) (= C6 1) ) 
	(< (bagunion M12 (bag d7) M13 (bag d5) M7 (bag d4) M6) (bag d3))
	(< (bag d3) M5) (= N5 (ite (= c4 0) N6 (+ N6 1)) ) (<= 0 c3) (<= c3 1) 
	(=> (= c3 0) (= c4 1) ) ( => (= c3 0) (= C5 1) ) 
	...
	(= cusnode2 ggrandpa2) (= iseven 1) (= c7 0) (= M11 (bagunion M12 (bag d7) M13 (bag d5) M7 (bag d4) M6 (bag d3) M5 ) ) 
	(= N11 (ite (= c3 0) N5 (+ N5 1) ) ) (= C11 c3)
	)
))
