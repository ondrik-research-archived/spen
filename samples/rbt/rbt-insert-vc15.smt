...
(assert 
	...
	(ssep 
		...
		(index alpha5 (rbrbthole gra grandpa1 M6 N6 0 M7 N7 0))
		(pto grandpa1 (sref (ref left X) (ref right Y) (ref data d4) (ref color 0)))
		(index alpha6 (rbt Y M11 N11 1))
		(pto X (sref (ref left U) (ref right V) (ref data d5) (ref color 1)))
		(index alpha7 (brrbthole U x M10 N10 1 M9 N9 1))
		(index alpha8 (rbt V M12 N12 1))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color 0)) ) 
	))
	(< M10 (bag d5))  (< (bag d5) M12) (= N10 N12) (< (bag M10 (bag d5) M12) (bag d4)) (< (bag d4) M11) & (= N12 N11) 
	...
	(= N2 (ite (= c1 0) N3 (+ N3 1)) ) (= M0 (bagminus M0bagminus M0 (bag key))) (distinct cusparent nil) (= grandpa2 U)
	)
)
...
(assert (not 
	...
	(ssep 
		...
		(index alpha13 (rbrbthole gra grandpa2 M6 N6 0 M10 N10 0))
		(index alpha14 (brrbthole grandpa2 x M10 N10 1 M9 N9 1))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref color 0)))
	))
