...
(assert 
	...
	(< (bag d1) M2) (= b1 H2) (<= -1 b1) (<= b1 1) (=  M0 (bagunion (bag d1) M2)) 
	(= parent root) (= unbparent nil) (= unbalance root) (> d1 key) (not (subset (bag key) M0))
	(= cur1 unbalance) (= b2 (- b1 1)) (= cur2 x)
	)
)
...
(assert (not 
	...
	(= parent root) (= unbparent nil) (= unbalance root)  (> d1 key) (not (subset (bag key) M0)) (= cur2 x)
	)
))
