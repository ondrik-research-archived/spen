...
(assert 
	...
	(ssep 
		...
		(pto unbalance (sref (ref left V) (ref right Z) (ref data d2) (ref balance 0)))
		(pto lft (sref (ref left U) (ref right unbalance) (ref data d4) (ref balance 0)))
		(index alpha2 (ubavlhole U parent M9 H10+1 M7 2))
		(index alpha3 (avl V M10 H10))
		(pto parent (sref (ref left x) (ref right nil) (ref data d3) (ref balance -1)))
	...
	(= b1 (- H3 (+ H10 2)) ) (<= -1 b1) (<= b1 1) (= M1 (bagunion M0 (bag key))) (not (subset (bag key) M0)) 
