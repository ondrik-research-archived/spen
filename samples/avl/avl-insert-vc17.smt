...
(assert 
	...
	(= b2 (- H5 H4)) (<= (- 0 1) b2) (<= b2 1) (= M2 (bagunion (bag d1) (bag d2) M4 M5 M3) ) 
	(< (bagunion (bag d2) M4 M5) (bag d1)) (< (bag d1) M3) 
	(= h (ite (> H5 H4) (+ H5 1) (+ H4 1) ) ) 
	(= b1 (- H3 h)) (<= (- 0 1) b1) (<= b1 1) (= M1 (bagunion M0 (bag key)) ) (= M0 (bagminus M0 (bag key)) )	
	(distinct parent nil) (distinct unbparent nil) (> d1 key) (> d2 key) (> d3 key) 
	(distinct b2 0) (= b3 0) (= cur1 unbalance) (= b4 (- b2 1)) (= cur2 Y) (= H7 (+ H4 1)) (= b5 0)
	)
)
...
(assert (not 
	...
	(< M4 (bag d2)) (< (bag d2) M5)(= b4  (- H5 H7)) (<= (- 0 2) b4) (<= b4 0) 
	(= M2 (bagunion (bag d1) (bag d2) M4 M5 M3) ) (< (bagunion (bag d2) M4 M5) (bag d1)) (< (bag d1) M3)
	(= h (ite (> H5 H4) (+ H5 1) (+ H4 1)) ) 
	(= b1 (- H3 h)) (<= (- 0 1) b1) (<= b1 1)
	(= M1 (bagunion M0 (bag key)) ) (= M0 (bagminus M0 (bag key)) ) (distinct parent nil)	
	(distinct unbparent nil) (> d1 key) (> d2 key) (> d3 key)
	(distinct b2 0) (= b3 0)  (= H7 (+ H4 1)) (= b5 0)
	)
))
