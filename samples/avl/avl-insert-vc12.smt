...
(assert 
	...
	(<= -1 b3) (<= b3 1) (ite (subset (bag key) M7) (= M6 (bagunion (bag d3) M7 M8)) (= M6 (bagunion (bag d3) M7 M8 (bag key))) )
	(ite (> H8 H7) (= H6 (+ H8 1)) (= H6 (+ H7 1)) ) (< M4 (bag d2)) (< (bag d2) M5) (= b2 (- H5 H4))
	(<= -1 b2) (<= b2 1)
	...
	(distinct parent nil) & (distinct unbparent nil) (> d1 key) (> d2 key) (> d3 key) (distinct b2 0) (= b3 0) (= cur nil)
	)
)
...
(assert (not 
	...
	(= M6 (bagunion (bag d3) (bag key))) (= H6  1)  (< M4 d2) (< d2 M5) (= b2 (- H5 H4)) (<= -1 b2)  (<= b2 1)
	(= M2 (bagunion (bag d1) (bag d2) M4 M5 M3)) (< (bagunion (bag d2) M4 M5) (bag d1)) (< (bag d1) M3) 
	(ite (> H5 H4) (= h (+ H5 1)) (= h (+ H4 1)) )  (= b1  (- H3 h)) (<= -1 b1) (<= b1 1)
	(= M1 (bagunion M0 (bag key)) ) (not (subset (bag key) M0)) 
	(distinct parent nil) (distinct unbparent nil) 
	(> d1 key) (> d2 key) (> d3 key) (distinct b2 0) (= b3 0)
	)
))
