...
(assert 
	...
	(tobool 
	(ssep 
		(pto root0 (sref (ref left V1) (ref right Y) (ref data d1) (ref balance 0)))
		(pto X (sref (ref left U) (ref right U1) (ref data d3) (ref balance -1)))
		(index alpha1 (ubavlhole U parent M8 H8 M3 H6))
		(pto V (sref (ref left lft) (ref right unbalance) (ref data d4) (ref balance 0))) 
	...
	(ite (> H11 H10) (= H9 (+ H11 1)) (= H9  (+ H10 1)) ) 
	(= b4  (- H11 H10)) (= b4 1)  (= M1  (bagunion (bag d3) M8 M9))
	(< M8 (bag d3)) (< (bag d3) M9) (ite (> H9 H8) (= H1  (+ H9  1)) (= H1 (+ H8 1)) )
	(= b3 (- H9 H8)) (<= -1 b3) (<= b3 1) (distinct b3 0) (distinct b3 -1) (= H4 1) (= H6 2)
	(= M0  (bagminus (bagunion (bag d1) M1 M4) (bag key)) ) (< M1 (bag d1)) (< (bag d1) M4)
	(= b1 (- H5 H1)) (= b1 -2) (not (subset (bag key) M0) ) & (distinct parent nil) (= unbparent nil) (= unbalance root0)
	(> d1 key) (> d2 key) (= b2 -1) (= cur  x)  (= lft X) (= lftright V) (= root1 lftright) (= ret root1)
	(= M7 (bagunion (bag d4) (bag d3)  M8  M10  (bag d1) M11 M4)) (= H7 (+ H8 2))
)
...
(assert (not 
	...
	(= M7 (bagunion M0 (bag key))) (not (subset (bag key) M0))
	)
))
