...
(assert 
	...
	(ssep 
		...
		(pto x (sref (left nil) (ref right nil) (ref data key) (ref balance 0)))
	))
	(< M4 d2) (< d2 M5) (= b2 (- H5 H4)) (<= -1 b2) (<= b2 1)
	(ite (subset (bag key) M4) (= M2 (bagunion (bag d1) (bag d2) M4 M5 M3)) (= M2 (bagunion (bag d1) (bag d2) M4 M5 M3 (bag key))) )
	(ite (> H5 H4) (= h (+ H5 1)) (= h (+ H4 1)) )  (ite (> H3 h) (= H2 (+ H3 1)) (= H2 (+ h 1)) )
	(< (bagunion (bag d2) M4 M5) (bag d1)) (< (bag d1) M3) (= b1 (- H3 h)) (<= -1 b1) (<= b1 1)
	( ite (subset (bag key) M0) (= M1 M0) (= M1  (bagunion M0 (bag key)) ) ) (iff (subset (bag key) M0) (subset (bag key) M4) ) 
	(distinct parent nil) (distinct unbparent nil) (= unbalance parent)	 
	(> d1 key) (> d2 key) (distinct b2 0) (= cur nil)
	)
)
...
(assert (not 
	...
	(< (bag d2) M5) (= b2  H5) (<= -1 b2) (<= b2 1)
	(= M2 (bagunion (bag d1) (bag d2) M4 M5 M3 (bag key)) ) (= h (+ H5 1)) 
	(ite (> H3 h) (= H2 (+ H3 1)) (= H2 (+ h 1)) )
	(< (bagunion (bag d2) M5) (bag d1)) (< (bag d1) M3) (= b1 (- H3 h)) (<= -1 b1) (<= b1 1)
	(= M1  (bag M0 (bag key)) ) (not (subset (bag key) M0)) (distinct parent nil) (distinct unbparent nil)
	(= unbalance parent) (> d1 key) (> d2 key) (distinct b2 0)
	)
))
