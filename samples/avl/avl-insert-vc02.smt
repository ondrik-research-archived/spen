...
(assert 
	...
	(= H4 (ite (> H9 H8) (+ H9 1) (+ H8 1) ) ) (= b3 (- H9 H8) ) 
	(<= (- 0 1) b3)(<= b3 1) (< M4 (bag d2)) (< (bag d2) M5)
...
(assert (not 
	...
	(< M8 (bag d3)) (< (bag d3) M9)
	(= b3  (- H9 H8)) (<= (- 0 1) b3) (<= b3 1) 
	(= M7 (ite (subset (bag key) M8) (bagunion (bag d2) (bag d3) M8 M9 M5) (bagunion (bag d2) (bag d3) M8 M9 M5 (bag key)) ) )
	(= H4 (ite (> H9 H8) (+ H9 1) (+ H8 1) ) ) 
	(= H7 (ite (> H5 H4) (+ H5 1) (+ H4 1) ) )	
