...
(assert 
	...
	(ite (> H8 H7) (= H3 (+ H8 1)) (= H3 (+ H7 1)) ) (= b3 (- H8 H7)) (= b3 0)
	(= M3 (bagunion (bag d2) (bag key)) ) (= H4 1) (= M0 (bagminus (bagunion (bag d1) M1 M4) (bag key)) ) 
	(< M1 (bag d1)) (< (bag d1) M4) (= b1 (- H5 H1)) (<= -2 b1) (<= b1 0)
	(not (subset (bag key) M0)) (distinct parent nil) (= unbparent nil) (= unbalance root) 
...
(assert (not 
	...
	(ssep 
		(pto root (sref (ref left X) (ref right Y) (ref data d1) (ref balance b1)))
		(index alpha1 (ubavlhole X cur2 M1 H1 M6 H6)) 
		(index alpha2 (bavlhole cur2 parent M6 H7 M3 H4))
		(pto parent (sref (ref left x) (ref right nil) (ref data d2) (ref balance b2)))
		(pto x (sref (ref left nil) (ref right nil) (ref data key) (ref balance 0))
	...
	(< M1 (bag d1)) ((bag d1) M4) (= b1 (- H5 H1)) (<= -2 b1) (<= b1 0)
	(not (subset (bag key) M0) ) (distinct parent nil) (= unbparent nil) (= unbalance root) 
	(> d1 key) (> d2 key) (= b2  0) (= H6 (+ H7 1)) (distinct cur2 unbalance)
	)
))
