...
(assert 
	...
	(= b3 (- H8 H7)) (<= -1 b3) (<= b3 1) (< M4 (bag d2)) (< (bag d2) M5)
	(= b2  (- H5 H4) (<= -1 b2) (<= b2 1) 
	(ite (subset (bag key) M4) (= M2 (bagunion (bag d1) (bag d2)  M4  M5  M3)) (= M2 (bag d1) (bag d2) M4 M5  M3 (bag key)) ) )
	...
	(> d3 key) (= cur2 U) (ite (subset (bag key) M7) (= M6 (bagunion (bag d2) M4 M5)) (= M6 (bagunion (bag d2) M4 M5 (bag key))) )
	(= H6 h)
	)
)
...
(assert (not 
	...
	(< M7 d3) (< d3 M8) (= b3  (- H8 H7))
	(<= -1 b3) (<= b3 1)
	(ite (subset (bag key) M7) (= M6  (bagunion (bag d2) (bag d3) M7  M8  M5) ) (= M6 (bagunion (bag d2) (bag d3) M7 M8 M5 (bag key)) ) )	
	( ite (> H8 H7) (= H4 (+ H8 1)) (= H4 (+ H7 1)) ) 
	(ite (> H5 H4) (= H6 (+ H5 1)) (= H6 (+ H4 1)) )
	(< (bagunion (bag d3) M7 M8) (bag d2) )(< (bag d2) M5)
	(= b2  (- H5 H4)) (<= -1 b2) (<= b2 1)
	( ite (subset (bag key) M0) (= M1 M0) (= M1 (bagunion M0 (bag key))) )
	(iff (subset (bag key) M0) (subset (bag key) M7) ) (distinct parent2 nil) (distinct unbparent2 nil)
