...
(assert (not 
	...
	(ssep 
		...
		(index alpha9 (ls x34 x36 )) 
		(pto x35 (ref next x34) ) 
		(pto x32 (ref next x31) ) 
		(index alpha10 (ls x30 x32 )) 
		(pto x31 (ref next x30) ) 
		(pto x28 (ref next x27) ) 
		(index alpha11 (ls x26 x28 )) 
		(pto x27 (ref next x26) ) 
		(pto x24 (ref next x23) ) 
		(index alpha12 (ls x22 x24 )) 
		(pto x23 (ref next x22) ) 
		(pto x20 (ref next x19) ) 
		(index alpha13 (ls x18 x20 )) 
		(pto x19 (ref next x18) ) 
		(pto x16 (ref next x15) ) 
		(index alpha14 (ls x14 x16 )) 
		(pto x15 (ref next x14) ) 
		(pto x12 (ref next x11) ) 
		(index alpha15 (ls x10 x12 )) 
		(pto x11 (ref next x10) ) 
		(pto x8 (ref next x7) ) 
		(index alpha16 (ls x6 x8 )) 
		(pto x7 (ref next x6) ) 
		(pto x4 (ref next x3) ) 
		(index alpha17 (ls x2 x4 )) 
		(pto x3 (ref next x2) ) 
	)
