...
(assert 
	...
	(tobool 
	(ssep 
		(index alpha0 (ls x35 x33 )) 
		(pto x33 (ref next x35) ) 
		(index alpha1 (ls x31 x29 )) 
		(pto x29 (ref next x31) ) 
		(index alpha2 (ls x27 x25 )) 
		(pto x25 (ref next x27) ) 
		(index alpha3 (ls x23 x21 )) 
		(pto x21 (ref next x23) ) 
		(index alpha4 (ls x19 x17 )) 
		(pto x17 (ref next x19) ) 
		(index alpha5 (ls x15 x13 )) 
...
(assert (not 
	(tobool 
	(ssep 
		(index alpha9 (ls x36 x33 )) 
		(pto x33 (ref next x36) ) 
		(index alpha10 (ls x32 x29 )) 
		(pto x29 (ref next x32) ) 
		(index alpha11 (ls x28 x25 )) 
		(pto x25 (ref next x28) ) 
		(index alpha12 (ls x24 x21 )) 
		(pto x21 (ref next x24) ) 
		(index alpha13 (ls x20 x17 )) 
		(pto x17 (ref next x20) ) 
		(index alpha14 (ls x16 x13 )) 
		(pto x13 (ref next x16) ) 
		(index alpha15 (ls x12 x9 )) 
		(pto x9 (ref next x12) ) 
		(index alpha16 (ls x8 x5 )) 
		(pto x5 (ref next x8) ) 
		(index alpha17 (ls x4 x1 )) 
		(pto x1 (ref next x4) ) 
	)
