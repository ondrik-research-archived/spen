...
(assert 
	...
	(tobool 
	(ssep 
		(index alpha0 (ls x23 x21 )) 
		(pto x21 (ref next x23) ) 
		(index alpha1 (ls x19 x17 )) 
		(pto x17 (ref next x19) ) 
		(index alpha2 (ls x15 x13 )) 
		(pto x13 (ref next x15) ) 
		(index alpha3 (ls x11 x9 )) 
		(pto x9 (ref next x11) ) 
		(index alpha4 (ls x7 x5 )) 
		(pto x5 (ref next x7) ) 
...
(assert (not 
	(tobool 
	(ssep 
		(index alpha6 (ls x24 x21 )) 
		(pto x21 (ref next x24) ) 
		(index alpha7 (ls x20 x17 )) 
		(pto x17 (ref next x20) ) 
		(index alpha8 (ls x16 x13 )) 
		(pto x13 (ref next x16) ) 
		(index alpha9 (ls x12 x9 )) 
		(pto x9 (ref next x12) ) 
		(index alpha10 (ls x8 x5 )) 
		(pto x5 (ref next x8) ) 
		(index alpha11 (ls x4 x1 )) 
		(pto x1 (ref next x4) ) 
	)
