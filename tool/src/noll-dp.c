 ...
 */
void noll_set_option(char* option) {
...
void print_help(void) {
	printf("noll-dp: decision procedure for NOLL, version 0.1\n");
	printf("Usage: noll-dp <file>\n");
	printf("\t<file>: input file in the SMTLIB2 format\n");
	printf(
			"See http://www.liafa.univ-paris-diderot.fr/celia/noll for more details.\n");
}
