...
noll_exp_t* noll_mk_and(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_or(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_not(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_eq(noll_context_t* ctx, noll_exp_t** args, uint_t size);
...
noll_exp_t* noll_mk_wsep(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_ssep(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_pto(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_ref(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_sref(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_index(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_sloc(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_unloc(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_inloc(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_eqloc(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_leloc(noll_context_t* ctx, noll_exp_t** args, uint_t size);
noll_exp_t* noll_mk_seloc(noll_context_t* ctx, noll_exp_t** args, uint_t size);
...
void noll_exp_push_pure(noll_context_t* ctx, noll_exp_t* e, noll_form_t* f);
